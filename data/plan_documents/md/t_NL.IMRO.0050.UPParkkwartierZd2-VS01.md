...
Parkkwartier Zuid fase 2: TOELICHTING

direct naar inhoud van TOELICHTING

Parkkwartier Zuid fase 2
...
| IMRO\-idn: | NL.IMRO.0050\.UPParkkwartierZd2\-VS01 |
...
![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0001.png"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0001.png)

*Figuur 1: Fragment geldend bestemmingsplan Polderwijk en Uitwerkingsplan Parkkwartier*

*Zuid (bron: ruimtelijkeplannen.nl)*

Voor een deel van het onderhavige plangebied is eerder het Uitwerkingsplan Parkkwartier Zuid vastgesteld (25 oktober 2016\). Een deel van de woningen die in dat plan zouden moeten worden gerealiseerd wordt in afwijking gebouwd van de (situerings)mogelijkheden die daarin worden geboden. Omdat het plan nog niet is verwezenlijkt, kan het college op grond van artikel 3\.6 lid 3 van de Wet ruimtelijke ordening opnieuw een uitwerkingsplan vaststellen voor deze delen waarin voornoemde afwijkingen zijn meegenomen. Het voorliggende uitwerkingsplan voorziet daarin.

Het voorliggende plan voorziet in een uitwerking van de nog in te vullen locaties aan de Swalmdal, de Springendal, de Maasduinen, de Beekvliet en de Biesbosch. Het gaat om in totaal 27 grondgebonden woningen en 15 woningen in een appartementengebouw. De ligging van het plangebied is weergegeven in figuur 2\.

![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0002.png"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0002.png)

*Figuur 2: Luchtfoto ligging plangebied (bron: PDOK, 2017\)*
...
Met dit uitwerkingsplan wordt de realisatie van 27 grondgebonden woningen en 15 gestapelde woningen mogelijk gemaakt in een gebied dat overigens al bouwrijp is en zal worden afgerond. In het volgende hoofdstuk wordt een beschrijving van de stedenbouwkundige uitgangspunten gegeven.
...
De uitwerking van het voorliggende plan betreft een afronding van woningbouw in de straatwanden de Swalmdal, de Springendal, de Beekvliet en de Biesbosch.

In het plangebied worden 8 blokken twee\-onder\-een\-kap\-woningen en 11 kavels voor vrijstaande woningen toegevoegd. In totaal 27 grondgebonden woningen. De vrije kavels worden verspreid over het plangebied toegevoegd, 4 aan de Weerribben, 3 aan de Swalmdal, 2 aan de Maasduinen en 2 aan het Springendal. De twee\-onder\-een\-kap\- woningen worden toegevoegd aan de Biesbosch (5 blokken) en aan de Swalmdal (3 blokken). Aan het Beekvliet wordt een vierlaags appartementencomplex gerealiseerd met ruimte voor 15 woningen. De afronding van het bestaande woongebied is weergegeven in figuur 3\.

![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0003.png"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0003.png)
...
Volledigheidshalve kan worden opgemerkt dat âde ladder voor duurzame verstedelijkingâ, zoals die is opgenomen in de Structuurvisie Infrastructuur en Ruimte (SVIR) en het procesvereiste van het Besluit ruimtelijke ordening (Bro) hier niet behoeft te worden doorlopen. Het gaat hier om woningen die worden gebouwd in een bestaande woonwijk die al bouwrijp is, waardoor er geen sprake is van een stedelijke ontwikkeling in de zin van de SVIR. Los daarvan is in de uitspraak van de Afdeling Bestuursrechtspraak van de Raad van State van 24 februari 2016 (zaaknummer 201506618/1\.R6\) bepaald dat een dergelijk onderzoek in uitwerkingsplannen feitelijk niet meer hoeft te worden gedaan.
...
![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0004.jpg"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0004.jpg)
...
Het wordt vanuit stedenbouwkundig oogpunt echter ongewenst geacht dat het erfbebouwingsgebied tussen vrijstaande woningen of blokken van rijtjes\- of twee\-onder\-een\-kap\-woningen wordt bebouwd met bijbehorende bouwwerken met opbouwen.

![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0005.png"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0005.png)

*Figuur 5: Ongewenste opbouwen bij woningen*

Hierdoor wordt het stedenbouwkundig beeld dat een open karakter (tussen de woningen) beoogd teniet gedaan. Omdat het bouwvlak in theorie volledig mag worden bebouwd met hoofdgebouwen, is een regeling opgenomen die ervoor zorgt dat het *oorspronkelijke*Â hoofdgebouw ten minste 2 meter vanaf de zijdelingse perceelgrens wordt gebouwd. Tussen de woningen kunnen op die manier uitsluitend bijbehorende bouwwerken worden gebouwd, waaronder ook de uitbreiding van het hoofdgebouw wordt verstaan. De regeling voor bijbehorende bouwwerken staat tot 4 meter vanaf het hoofdgebouw maar Ã©Ã©n bouwlaag toe (zie figuur 6\), waardoor een kapconstructie tussen de woningen, zoals afgebeeld in figuur 5, kan worden voorkomen.

![afbeelding "i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0006.png"](i_NL.IMRO.0050.UPParkkwartierZd2-VS01_0006.png)

*Figuur 6: Maatvoering bijbehorende bouwwerken naast/tussen hoofdgebouwen*
...
De bestemming 'Wonen' heeft betrekking op de resterende in te vullen woonkavels van het Parkkwartier Zuid. Dit betreffen de woningen inclusief de daarbijbehorende achter\- en zijtuinen.

De bouwregels van de woningen (hoofdgebouwen) zijn afgestemd op de in paragraaf 3\.2Â beschreven woningtypen. De situering van de hoofdgebouwen is vastgelegd in het bouwvlak. Daar waar sprake is van een bouwstroom, kunnen meerdere hoofdgebouwen van het type twee\-onder\-een\-kap worden gebouwd. Tussen de (blokken) woningen dient een afstand van 2 meter tot de zijdelingse perceelgrens te worden aangehouden.

Buiten het bouwvlak is ruimte voor (vergunningvrije) erfbebouwing (zie paragraaf 5\.2). Het wonen mag in combinatie plaatsvinden met kleinschalige beroeps\- en bedrijfsmatige activiteiten aan huis. EÃ©n en ander is gehouden aan een aantal randvoorwaarden en beperkingen die in de begrippen en de gebruiksregels van de bestemming zijn opgenomen.

#### 5\.5 Wonen \- Woongebouw

De bestemming 'Wonen \- Woongebouw' heeft betrekking op het appartementengebouw aan het Beekvliet met de daarbijbehorende ruimte voor parkeren, bijbehorende bouwwerken en dergelijke. De bouwregels van de gebouwen zijn afgestemd op de in paragraaf 3\.2 beschreven woningtypen. De situering van het gebouw is vastgelegd in het bouwvlak. Buiten het bouwvlak is alleen ruimte voor andere bouwwerken, zoals erf\- en terreinafscheidingen en vlaggenmasten.

...
Opheusden, Hamsestraat \- Herenland: Toelichting

direct naar inhoud van Toelichting

Opheusden, Hamsestraat \- Herenland
...
| Plan: | Opheusden, Hamsestraat \- Herenland |
...
| IMRO\-idn: | NL.IMRO.1740\.wpOPhamsestrherenl\-vst1 |
...
De initiatiefnemer heeft het voornemen om Ã©Ã©n nieuwe woning met bijgebouw te realiseren op het perceel aan de Hamsestraat 39 \- Gerrit Achterbergstraat in Opheusden. Hiervoor wordt de bestaande garage op deze locatie gesloopt.

De voorgenomen ontwikkeling past niet in het geldende bestemmingsplan. Om de ontwikkeling mogelijk te maken wordt gebruik gemaakt van een wijzigingsbevoegdheid uit het recent vastgestelde bestemmingsplan. In voorliggend wijzigingsplan (vorm van bestemmingsplan) wordt gemotiveerd waarom medewerking wordt verleend en waarom dat kan volgens de Wet ruimtelijke ordening (Wro).

#### 1\.2 Ligging plangebied

Het plangebied is gelegen op de hoek van de Hamsestraat 39 en de Gerrit Achterbergstraat in het westen van de kern Opheusden.

![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0002.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0002.png)

*Afbeelding 1\.1: globale ligging en begrenzing plangebied*

#### 1\.3 Geldende plannen

Voor de in het bestemmingsplan begrepen gronden vigeert thans het bestemmingsplan 'Kernen Neder\-Betuwe', vastgesteld door de gemeenteraad op 8 november 2019\. Het plangebied heeft hierin de enkelbestemming 'Wonen' met een bouwvlak en de bouwaanduidingen 'vrijstaand' en 'bijgebouwen'. Een hoekje in het zuidoosten van het plangebied heeft de enkelbestemming 'Verkeer \- Verblijfsgebied'. Het noordelijk deel van het plangebied heeft de dubbelbestemming 'Waarde \- Archeologie 1'.

![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0003.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0003.png)

Uitsnede bestemmingsplan "Kernen Neder\-Betuwe"

*Strijdigheid met het vigerende bestemmingsplan*

Het plangebied heeft de bestemming 'Wonen'. Echter is er geen bouwvlak in het zuidelijke deel van het plangebied, waardoor de bouw van een vrijstaande woning daar strijdig is met het geldende bestemmingsplan. Conform een wijzigingsbevoegdheid in het vigerende bestemmingsplan is het mogelijk om de bestemming te wijzigen teneinde Ã©Ã©n extra woning toe te staan. Hierbij moet aan een aantal voorwaarden worden voldaan. Hieronder wordt het artikel benoemd en beschreven hoe aan de voorwaarden wordt voldaan.
...
* a. Met voorliggend plan wordt Ã©Ã©n extra vrijstaande woning mogelijk gemaakt;

* b. De afstand van de vrijstaande woning tot de zijdelingse perceelsgrens bedraagt aan twee zijden minimaal 3 meter (zie het aangegeven bouwvlak op de verbeelding);

* c. de maatvoering sluit aan op de stedenbouwkundige karakteristiek van de omgeving: goot\- en bouwhoogte van respectievelijk 6 en 9 meter;
...
* g. Op de verbeelding zijn de aanduidingen 'bouwvlak', 'bijgebouwen' en de specifieke bouwaanduiding 'vrijstaand' opgenomen;

* h. De woning wordt direct vanaf de Gerrit Achterbergstraat ontsloten en is op deze weg georiÃ«nteerd;

* i. De afstand van de nieuwe woning tot de achterste perceelsgrens is minimaal 8 meter (zie schetsontwerp in bijlage 1);

* j. De bepalingen in Artikel 21 Wonen van het geldende bestemmingsplan zijn overgenomen in dit plan (zie Artikel 3 Wonen).
...
Het plangebied ligt aan de Hamsestraat 39 en de Gerrit Achterbergstraat in het westelijk deel van de kern Opheusden. Direct ten zuiden van het plangebied is de nieuwbouwwijk Herenland gelegen. De locatie wordt ontsloten via de oostelijk gelegen Gerrit Achterbergstraat. Het perceel heeft een grote omvang. Op het perceel bevindt zich een vrijstaande woning en een grote garage. Het overige deel is ingericht als tuin. De onderstaande afbeelding toont een luchtfoto van het plangebied.

![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0004.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0004.png)

Luchtfoto van het plangebied

#### 2\.2 Toekomstige situatie

In de toekomstige situatie wordt het perceel in twee delen gesplitst en wordt de grote garage gesloopt. Op de locatie van de garage wordt een nieuwe vrijstaande woning met garage gerealiseerd. De nieuwe woning wordt daarmee ten zuiden van de bestaande woning gesitueerd. De onderstaande afbeelding toont het schetsontwerp van de toekomstige situatie. Het hele schetsontwerp inclusief legenda is toegevoegd als bijlage 1.

![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0005.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0005.png)

Uitsnede schetsontwerp

De bestaande woning wordt ontsloten via de Hamsestraat met een garage en inrit aan de westzijde van de woning. De nieuwe woning wordt ontsloten via de Gerrit Achterbergstraat. Voor de ontsluiting wordt een klein stuk grond van de gemeente aangekocht (blauwe vierkant op schetsontwerp) en een lantaarnpaal verplaatst. Het parkeren zal deels plaatsvinden op eigen terrein. Beide woningen krijgen een garage met dubbele oprit. Bij de bestaande woningen is op de inrit ruimte om vier auto's te parkeren. Bij de nieuwe woning is ruimte om drie auto's te parkeren. De bestaande bomen langs de oostzijde van het plangebied blijven behouden. Tevens worden nieuwe bomen en hagen in het plangebied aangeplant.
...
Het plan betreft de realisatie van Ã©Ã©n woning binnen bestaand bebouwd gebied. De provinciale Omgevingsvisie en Omgevingsverordening stellen geen specifieke eisen aan voorliggende locatie. Geconcludeerd wordt dat het plan passend is binnen het provinciale beleid.
...
![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0006.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0006.png)
...
De Dalwagenseweg\-Burgemeester Lodderstraat\-Dorpsstraat\-Hamsestrat (paarse kleur, ontwikkelingsrichting werken tot 2020\) is de centrale as van de kern Opheusden. Langs deze route zijn de historische bebouwing (wonen en bedrijvigheid) en voorzieningen gelegen. Het plangebied ligt aan de Hamsestraat met direct ten zuiden van de locatie de nieuwbouwwijk Herenland. Het realiseren van een woning op deze locatie past binnen de Structuurvisie.
...
![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0007.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0007.png)
...
Onderhavig initiatief betreft de realisatie van Ã©Ã©n nieuwe woning in het hogere segment. In de woonvisie wordt dit segment als kansrijk benoemd. Voorliggend plan levert met Ã©Ã©n nieuwe woning een bijdrage aan het invullen van de nieuwbouwopgave voor de kern Opheusden. Het plan sluit daarmee aan op de uitgangspunten van de Woonvisie 2016\-2021\.
...
Met voorliggend plan wordt Ã©Ã©n extra vrijstaande woning gerealiseerd. Hierdoor zal het aantal verkeersbewegingen met maximaal 8,6 verkeersbewegingen per etmaal toenemen. De nieuwe woning wordt ontsloten via de Gerrit Achterbergstraat. Deze weg heeft voldoende capaciteit om deze beperkte toename aan verkeersbewegingen op te vangen. De bestaande woning wordt ontsloten via de Hamsestraat met een inrit aan de westzijde van de woning.
...
Voor een vrijstaande woning geldt een parkeernorm van 2,7, is afgerond 3 parkeerplaatsen. Bij de nieuwe woning is ruimte om op eigen terrein 3 auto's te parkeren. Bij de bestaande woning is op de nieuwe inrit ruimte om op eigen terrein 4 auto's te parkeren.
...
In het kader van de voorgenomen ontwikkeling is een verkennend bodemonderzoek uitgevoerd. De belangrijkste resultaten zijn hieronder weergegeven, de volledige rapportage is als bijlage 2 bij de toelichting opgenomen. Geconcludeerd wordt dat enkele verhoogde metaalgehaltes zijn aangetroffen welke onder de tussenwaarde liggen en geen verder aandacht behoeven. Daarnaast zijn enkele PAK's gehaltes aangetroffen boven de tussenwaarde. Hierbij kan niet worden uitgesloten dat in Ã©Ã©n van de deelmonsters het PAKâs gehalte boven de interventiewaarde ligt. Hiernaar dient nader onderzoek gedaan te worden. Dit nader onderzoek is uitgevoerd en toegevoegd als bijlage 3. Hierin wordt geconcludeerd dat de PAKâs\-vervuiling met gehaltes boven de interventiewaarde zich in de toplaag bevindt over een oppervlak van ca. 30 mÂ². Het volume van de PAKâs\-vervuiling met gehaltes boven de interventiewaarde is ca. 15 mÂ³. De PAKâs\-vervuiling is ontstaan voor 1987 en omvat een volume kleiner dan 25 mÂ³ met gehaltes boven de interventiewaarde. Het is daarmee een niet ernstig, historisch geval van bodemverontreiniging. Bij gewijzigd gebruik zoals herinrichting t.b.v. nieuwbouw dient de ernstig vervuilde grond bij verwijdering afgevoerd te worden naar een erkende verwerker.
...
![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0008.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0008.png)
...
De beoogde ontwikkeling maakt een nieuw geluidsgevoelig object mogelijk, namelijk Ã©Ã©n woning. De nieuwe woning wordt ontsloten via de Gerrit Achterbergstraat. Hier is sprake van een 30 km zone. Dergelijke wegen hebben volgens artikel 74 lid 2 van de Wgh geen onderzoekszone en zijn daarmee niet onderzoeksplichtig. Gezien er sprake is van een rustige weg met voornamelijk bestemmingsverkeer is er ook sprake van een goede ruimtelijke ordening.
...
![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0009.jpg"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0009.jpg)
...
Het plangebied ligt in een woonwijk met rondom geen andere functies dan wonen. In de omgeving van het plangebied zijn verder enkele bedrijven aanwezig. In onderstaande tabel zijn de adressen en maximaal toegestane milieucategorieÃ«n van de aanwezige bedrijven en inrichtingen weergegeven.

| **Adres**   Â | **Inrichting**   Â | **Toelaatbare milieucategorie**   Â | **Maatgevende aspect**   Â | **Richtafstand (in m)\***   Â | **Feitelijke afstand (in m)**   Â |

| --- | --- | --- | --- | --- | --- |

| Hamsestraat 38   Â | Winkel    Â | 1   Â | Geluid   Â | 10   Â | 60   Â |

| Hamsestraat 36   Â | Kantoor   Â | 1   Â | Geluid   Â | 10   Â | 70   Â |

*\* de gereduceerde richtafstand is tussen haakjes weergegeven*

*Tabel 4\.3: overzicht relevante bedrijvigheid*

Aan de genoemde richtafstanden wordt ruimschoots voldaan. Overige bedrijven en functies liggen op een nog grotere afstand van het plangebied. Er zal in de nieuwe woning sprake zijn van een goed woon\- en leefklimaat en er worden met het initiatief geen bedrijven en functies belemmerd in hun bedrijfsvoering.
...
![afbeelding "i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0010.png"](i_NL.IMRO.1740.wpOPhamsestrherenl-vst1_0010.png)
...
Voor onderhavig plan is de digitale watertoets uitgevoerd. Het resultaat hiervan is toegevoegd als bijlage 4. Op het deel van het plangebied waar de nieuwe woning beoogd is staat een grote garage en is het plangebied grotendeels verhard. Het waterschap hanteert voor stedelijk gebied een drempelwaarde van 500 mÂ² aan toename verharding waarbij compenserende maatregelen dienen te worden genomen. Met voorliggend plan blijft de toename aan verharding ruim onder deze drempelwaarde. Daarom is watercompensatie niet nodig. Er liggen geen (beschermingszones van) beschermde waterkeringen en/of watergangen in het plangebied. Het hemelwater en afvalwater zal overeenkomstig de huidige situatie gescheiden worden afgevoerd.
...
In het kader van de voorgenomen ontwikkeling is een flora en fauna onderzoek uitgevoerd. De belangrijkste resultaten zijn hieronder weergegeven, de volledige rapportage is als bijlage 5 bij de toelichting opgenomen. Hierin wordt geconcludeerd dat er nader onderzoek nodig is naar de mogelijke aanwezigheid van verblijfplaatsen van vleermuizen. Het rapport van dit nader onderzoek is toegevoegd als bijlage 6. Hierin wordt geconcludeerd dat het plangebied enkel deel uitmaakt van een paarterritorium, maar niet van een verblijfplaats van vleermuizen. Het plan is daarmee op basis van de Wro uitvoerbaar op het gebied van soortenbescherming. Tijdens de werkzaamheden dient zorgvuldig te worden gehandeld.

###### 4\.9\.2\.2 Gebiedsbescherming

Het plangebied maakt geen deel uit van een Natura 2000\-gebied of Natuurnetwerk Nederland. Op een afstand van circa 500 meter ten noorden van het plangebied ligt het Natura 2000\-gebied 'Rijntakken'. Door de geringe omvang van de ontwikkeling (realiseren van 1 woning) en de afstand tot het te beschermen gebied, kan het optreden van significante negatieve effecten worden uitgesloten.

Gezien de geringe omvang en de afstanden tot het stikstofgevoelige gebied is er geen aanleiding te veronderstellen dat de stikstofdepositie als gevolg van de bouw en het gebruik van de woning substantieel effect heeft.Â
...
Met het bestemmingsplan 'Parapluplan Archeologie' is voor het gehele plangebied van de gemeente Neder\-Betuwe de archeologische verwachtingswaarde geregeld. Het noordelijk deel van het plangebied heeft de dubbelbestemming 'Waarde \- Archeologie 1'. Hierbij geldt een onderzoeksplicht bij bodemingrepen met een oppervlakte groter dan 100 mÂ² en dieper dan 30 cm onder het maaiveld. In dit deel van het plangebied staat echter de bestaande woning en zullen geen bodemingrepen worden uitgevoerd. Het zuidelijk deel van het plangebied heeft geen dubbelbestemming archeologie.
...
Waarbij Ã©Ã©n bouwvlak is opgenomen ten behoeve van de nieuwe woning. Het bouwvlak heeft de bouwaanduiding 'vrijstaand'. De maximaal toegestane goot\- en bouwhoogte van de nieuwe woning bedraagt respectievelijk 6 en 9 meter.
...
Het ontwerpwijzigingsplan heeft vanaf 19 november tot en met 30 december 2020 voor een termijn van zes weken ter inzage gelegen. Gedurende deze periode zijn er geen zienswijzen ingediend.

...
|    | 1.2                       | Ontwikkeling                               | 1  |  |  |
|    | 1.3                       | Plangebied en geldend bestemmingsplan      | 1  |  |  |
| 2. | BELEIDSKADER              |                                            |    |  |  |
|    | 3.1                       | Rijk                                       | 3  |  |  |
|    | 3.2                       | Provincie                                  | 4  |  |  |
|    | 3.3                       | Regio                                      | 5  |  |  |
...
|    | 4.1                       | Milieuaspecten                             | 10 |  |  |
|    | 4.2                       | Fysieke aspecten                           | 13 |  |  |
|    | 4.3                       | Economische<br>en financiële<br>aspecten   | 17 |  |  |
|    | 4.4                       | Handhaafbaarheid                           | 17 |  |  |
| 4. | JURIDISCHE VERANTWOORDING |                                            |    |  |  |
|    | 5.1                       | Algemeen                                   | 18 |  |  |
|    | 5.2                       | Toelichting op de regels en de verbeelding | 18 |  |  |
| 5. | (VOOR)OVERLEG             | 20                                         |    |  |  |
...
Het perceel Oploseweg 3a is een ruim perceel dat is gelegen aan de Oploseweg en de Zandstraat. De achtertuin van de vrijstaande woning grenst aan de Zandstraat. Het perceel is voldoende groot om een tweede woning te realiseren. De vigerende bestemmingsplannen 'Buitengebied 2008' en 'Oploseweg 3' bieden geen ruimte om op deze locatie een woning toe te voegen. Voorliggend plan maakt de realisatie van de nieuw te bouwen woning mogelijk.

**Figuur 1 Perceel Oploseweg 3a**

### **1.2 Ontwikkeling**

Voorgenomen ontwikkeling bestaat uit de bouw van één vrijstaande woning, met daarbij behorende bijgebouwen en voorzieningen, op het 'achter perceel'. De beoogde locatie is gelegen binnen de grenzen van het stedelijk gebied, zoals gehanteerd in de Verordening Ruimte. De woning wordt georiënteerd op de Zandstraat en zal tevens via deze erftoegangsweg ontsloten worden.

### **1.3 Plangebied en geldend bestemmingsplan**

Het betreft kadastraal perceel U520. Voor de realisatie van de bestaande bebouwing, Oploseweg 3a, is aan het voorste gedeelte van het perceel de functie 'wonen' toegekend. Hiertoe is, in 2010, het bestemmingsplan 'Oploseweg 3, Overloon' opgesteld. Het overige deel van het perceel ligt in het bestemmingsplan 'Buitengebied 2008' en heeft de bestemming 'AHS-Landbouw'.

Over het deel van het perceel dat gelegen is in het bestemmingsplan 'Buitengebied 2008' loopt de grens van het bestaand stedelijk gebied. De rode lijn geeft de grens aan tussen het stedelijk gebied en het buitengebied ('gemengd landelijkgebied'). De nieuw te bouwen woning zal binnen de grenzen van het bestaand stedelijk gebied worden gebouwd.
...
### **2.1.3 Het Nationaal Milieubeleidsplan 4 (NMP4)**
...
De Verordening Ruimte 2014 is niet van toepassing. De woning word gebouwd op het deel van het perceel dat binnen de grenzen van het bestaand stedelijk gebied valt.
...
Omdat het om het toevoegen van slechts één woning gaat zal dit geen invloed hebben op het bouwprogramma van Overloon.
...
Volgens het gemeentelijk beleid valt het gebied in gebiedstype C. De ambitie waarde voor dit gebied is vastgesteld op 43 dB en de basiswaarde op 53 dB.

Akoestisch onderzoek toont aan dat op de locatie de voorkeursgrenswaarde van 48 dB (inclusief aftrek, Reken- en meetvoorschrift geluidhinder 2012) op de gevels van de nieuwe woning niet wordt overschreden. Ook wordt voldaan aan de ambitiewaarde van de Geluidnota gebiedsgericht geluidbeleid gemeente Boxmeer.

**Conclusie:** uit akoestisch oogpunt zijn er geen belemmeringen tegen de realisatie van de nieuwe woning.
...
De nu geldende welstandsnota laat zien dat voor de locatie welstandsniveau 2 geldt. Het geldende bebouwingstype is G3 (boerenerf, agrarisch buitengebied). De bouwplannen zullen, door de Commissie Ruimtelijke Kwaliteit, beoordeeld worden.
...
In de directe omgeving zijn geen bedrijven gelegen waarvoor de planontwikkeling enig gevolg heeft. Aan de Oploseweg is het bedrijf Henra gelegen. In het verleden is er een akoestisch onderzoek uitgevoerd voor planontwikkeling (bouw woning) aan de Oploseweg waarbij geconcludeerd is dat deze ook geen beperking zijn voor Herna. De gevraagde planlocatie is op een grotere afstand gelegen.
...
Uit verkennend bodemonderzoek is gebleken dat de hypothese "onverdachte locatie" worden aanvaard, ondanks de verhogingen met zware metalen en naftaleen in het grondwater.

Verontreinigingen met zware metalen in het grondwater zijn te relateren aan de regionale problematiek met betrekking tot zware metalen in de bodem en het doorsijpelen naar het grondwater. De verhoging met naftaleen kan niet worden verklaard.

Een nader onderzoek is gezien de gehalten niet noodzakelijk. Er is geen gevaar voor de volksgezondheid. De hergebruiksmogelijkheden voor de grond, die eventueel vrijkomt bij toekomstige bouwactiviteiten, kunnen, indicatief gezien, als multifunctioneel worden beschouwd. Hergebruik dient te geschieden conform het Besluit bodemkwaliteit.
...
| Inrichtingen<br>(Bevi)                    | Altijd wanneer binnen invloedsgebied een ruimtelijk besluit wordt genomen.                                                                                                                                                                                                                                                                                                                                                                                                      |
|-------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Buisleidingen (Bevb)                      | Altijd wanneer binnen invloedsgebied een ruimtelijk besluit wordt genomen.<br>Er kan echter worden volstaan met een beperkte verantwoording<br>wanneer:<br>1.<br>het groepsrisico lager is dan 0,1 keer de oriëntatiewaarde, of<br>2.<br>de toename minder is dan 0,1 keer de oriëntatiewaarde, of<br>3.<br>personen zich buiten de 100% letaliteitgrens bevinden.<br>Bij een beperkte verantwoording hoeven alleen zelfredzaamheid en<br>bestrijdbaarheid beschouwd te worden. |
| Spoor-, rijks-<br>en<br>Waterwegen (Bevt) | Altijd wanneer binnen invloedsgebied een ruimtelijk besluit wordt genomen.<br>Er kan echter worden volstaan met een beperkte verantwoording wanneer:<br>1.<br>het groepsrisico lager is dan 0,1 keer de oriëntatiewaarde, of<br>2.<br>de toename minder is dan 0,1 keer de oriëntatiewaarde, of<br>3.<br>personen zich buiten de 200 meter-zone<br>bevinden.<br>Bij een beperkte verantwoording hoeven alleen zelfredzaamheid en<br>bestrijdbaarheid beschouwd te<br>worden.    |
...
Om de risico's in (de omgeving van) het plangebied te inventariseren is de nationale risicokaart geraadpleegd.

Ten noordwesten van het plangebied (groene cirkel in onderstaand kaartje) bevindt zich een propaantank (rode stip), waarop veiligheidsafstanden uit het Activiteitenbesluit van toepassing zijn. Deze afstanden (maximaal 20 meter) reiken echter niet tot het plangebied. Overige relevante risicocontouren van inrichtingen, transportroutes (weg, spoor of water) en/of buisleidingen zijn niet aanwezig. Nader onderzoek naar het aspect externe veiligheid is niet noodzakelijk. **Conclusie:** Externe veiligheid vormt geen belemmering voor het ruimtelijk plan.
...
Het perceel is gelegen in een gebied met aanduiding "Archeologisch onderzoeksgebied B". Daarom is de dubbelbestemming "Waarde archeologie 4" in de regels opgenomen.
...
Er is een quickscan flora en fauna uitgevoerd. Door het literatuuronderzoek van de inventarisatie is aangetoond dat het mogelijk is dat in het gebied beschermde flora of fauna (voornamelijk vleermuizen, broed- en wintervogels) voor kunnen komen (zie inventarisatie Natuurloket). In de nabijheid van het perceel zijn tijdens de veldbezoeken in november 2017 echter geen waarnemingen gedaan van schaarse soorten. Ook rondom het perceel zijn bij de inventarisaties geen waarnemingen gedaan van beschermde soorten (waaronder Huismussen, Gierzwaluwen en vleermuisssoorten).

De veldonderzoeken, uitgevoerd in de dag- en avondperiode op 16 november 2017, zijn buiten het broedvogelseizoen uitgevoerd. Daarom is er speciale aandacht besteed aan andere kenmerken van broedende vogelsoorten. Onder andere uitwerpselen van broedvogelsoorten en hun kuikens, achtergebleven nestmaterialen, vraatsporen en uitwerpselen zijn kenmerken waarop speciaal is gelet. Het veldonderzoek kan daarom als vrij uitvoerig worden beschouwd. Bij de inventarisatie is ook aandacht besteed aan verblijfplaatsen van vleermuizen en nestkasten en -mogelijkheden in het gebied. Ook in de bomen in de omgeving en in het schuurtje op het perceel is degelijk onderzoek uitgevoerd op o.a. toegangsmogelijkheden en verblijfplaatsen van vleermuizen en jaarrond beschermde soorten zoals Huismussen en Gierzwaluwen. Bij de inventarisatie van de vleermuizen is extra aandacht besteed aan mestsporen, keutels en vraatsporen.
...
Door de nieuwbouw van de woning, wordt het karakter van het gebied niet beïnvloed. Er verdwijnen geen verblijfs- of broedmogelijkheden. Het is onwaarschijnlijk dat broedende soorten in de omgeving door de werkzaamheden worden verstoord.
...
Het perceel ligt aan twee erftoegangswegen: Oploseweg en Zandstraat. De Oploseweg en de eerste 50 meter van de Zandstraat liggen binnen de bebouwde kom waar een maximale snelheid van 30 km/u geldt. Het resterende deel van de Zandstraat ligt buiten de bebouwde kom. Hier geldt een maximale snelheid van 60 km/u. Aan dit deel staat wat verspreide bebouwing. De te bouwen woning komt net buiten de komgrens te liggen en zal ontsloten worden via de Zandstraat. Voor de realisatie van de in-/uitrit aan de Zandstraat is een omgevingsvergunning vereist. Parkeren dient op eigenterrein plaats te vinden. De parkeer norm voor een vrijstaande koopwoning in het buitengebied is 2,4 parkeerplaats/woning.
...
| Koopwoning<br>twee-onder-een-kap  | 1.7     | 2.0   | 2.2                     | 2.2               | Per woning |
| Koopwoning<br>tusen/hoek          | 1.5     | 1.8   | 2.0                     | 2.0               | Per woning |
...
| Huurappartement<br>mdden/goedkoop | 1.1     | 1.2   | 1.4                     | 1.4               | Per woning |
| Aanleunwoning of serviceflat      | 1.1     | 1.1   | 1.2                     | 1.2               | Per woning |

**Figuur 3 Nota parkeernormen Boxmeer 2015**
...
De nieuw te bouwen woning kan op de bestaande drukriolering worden aangesloten. Het regenwater moet op eigenterrein geborgen worden tegen een berging van 30mm/m2 verhard oppervlak. Het van de inrit afkomend regenwater moet ook op eigenterrein geborgen worden en mag absoluut niet naar de weg. Dit leidt tot verweking van de berm en tot schade aan de asfaltweg.
...
- Externe veiligheid; ODBN, 18 mei 2017
- Flora en fauna onderzoek; M&A Omgeving Bv, 21 december 2017
- Bodem onderzoek ; M&A Omgeving Bv, 14 december 2017
- Akoestisch onderzoek; M&A Omgeving Bv, 21 december 2017
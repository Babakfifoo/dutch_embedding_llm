...
| afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0014.png"      Â |
...
*3\. In het kader van de toelichting als bedoeld in lid 1 wordt gemotiveerd dat de nieuwe ontwikkeling past binnen*
...
![afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0025.png"](i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0025.png)
...
| afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0026.png"      Â |

| --- |

| *Tabel 1: Milieubelastende functies in de nabijheid van de locaties (Bron: BJZ.NU)*   Â |

*\* Met uitzondering van het aspect 'geur'. Bij veehouderijen zijn niet de adviesafstanden maar de wettelijk aan te*

*houden afstanden of de berekenende geuremissiecontouren voor vergunningsplichtige veebedrijven bepalend. In*

*paragraaf 5\.6 wordt nader op het aspect geur ingegaan.*
...
| afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0027.png"      Â |

| --- |

| *Figuur 5\.3: Ligging van het plangebied ten opzichte van het Natura 2000\-gebied 'Borkeld' en ten opzichte van het Natuur Netwerk Nederland (Bron: Provincie Overijssel)*   Â |

##### 5\.7\.2 Soortenbescherming

Wat betreft de soortbescherming is de Wet natuurbescherming van toepassing. Hierin wordt onder andere de bescherming van dier\- en plantensoorten geregeld. Bij ruimtelijke ontwikkelingen dient te worden getoetst of er sprake is van negatieve effecten op de aanwezige natuurwaarden. Als hiervan sprake is, moet ontheffing of vrijstelling worden gevraagd.

Om te beoordelen of de ontwikkeling in het kader van flora en fauna uitvoerbaar is, dient een quickscan natuurwaarden te worden uitgevoerd. Ter plaatse van de beoogde woningen aan de Potdijk 7 is door Eelerwoude een quickscan natuuwaarden uitgevoerd. Hierna wordt op de belangrijkste resultaten ingegaan. Voor de volledige rapportage wordt verwezen naar Bijlage 1 van deze toelichting.

*Resultaten quickscan Potdijk 7*
...
Voor veel soorten maakt het plangebied onderdeel uit van het leefgebied. Dit betreft echter geen essentieel onderdeel en is ook na de ontwikkeling nog steeds voorhanden als leefgebied.
...
| afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0028.png"      Â |

| --- |

| *Figuur 5\.5: Uitsnede archeologische verwachtings\- en advieskaart (Bron: gemeente Hof van Twente)*   Â |
...
In de Bro is sinds 1 januari 2012 (artikel 3\.1\.6, vijfde lid, onderdeel a) opgenomen dat een bestemmingsplan *âeen beschrijving van de wijze waarop met de in het gebied aanwezige cultuurhistorische waarden en in de grond*
...
| afbeelding "i_NL.IMRO.1735.BGxMKpotdijk7-VS10_0029.png"      Â |

| --- |

| *Figuur 6\.1: Watertoetstabel (Bron: Waterschap Rijn en IJssel)*   Â |

**Wateroverlast (oppervlaktewater en afvalwater)**

Als gevolg van het plan is er sprake van een beperkte toename van het afvalwater. Het rioolstelsel is dusdanig ingericht dat het deze beperkte toename eenvoudig kan verwerken. Tevens wordt er veel bestaand verhard oppervlakte gesaneerd, wat een positief effect heeft op de waterafvoer. Het hemelwater zal op eigen terrein worden opgevangen en geÃ¯nfiltreerd. De toename van afvalwater brengt geen belemmeringen met zich mee.
...
In de Wet ruimtelijke ordening (Wro) die op 1 juli 2008 in werking is getreden, is de verplichting opgenomen om ruimtelijke plannen en besluiten digitaal vast te stellen. De digitaliseringsverplichting geldt vanaf 1 januari 2010\. Dit bestemmingplan is opgesteld conform de normen van de SVBP 2012 (Standaard voor vergelijkbare bestemmingsplannen 2012\). De Standaard Vergelijkbare Bestemmingsplannen maakt het mogelijk bestemmingsplannen te maken die op vergelijkbare wijze zijn opgebouwd en op een zelfde manier worden verbeeld. Vergelijkbare bestemmingsplannen leiden tot een betere dienstverlening en tot een effectievere en efficiÃ«ntere overheid.
...
* *Algemene bouwregels*Â *(Artikel 10)*: Dit artikel bevat diverse regels omtrent bestaande maatvoering, dakhelling van gebouwen, situering van woningen, herbouw of nieuwbouw van gebouwen in geval van calamiteit en situering van bijgebouwen en paardenbakken.
...
De voor 'Wonen' aangewezen gronden zijn bestemd voor Ã©Ã©n woning per bestemmingsvlak. Voor de woningen geldt dat de bouwhoogte maximaal 10 meter en de goothoogte maximaal 4 meter bedraagt. De inhoud van de woningen mag per woning maximaal 750 m3 bedragen, tenzij op de verbeelding de specifieke bouwaanduiding 'dubbele bewoning' is opgenomen, in dat geval mag de inhoud van de woning 1\.000m3Â bedragen. Voor bijgebouwen is opgenomen dat de gezamenlijke oppervlakte maximaal 150 m2 bedraagt. Ter plaatse van de specifieke bouwaanduiding 'inpandig bijgebouw' mag de inhoud van de woning 900m3Â bedragen, met dien verstande dat hier enkel een inpandig bijgebouw mag worden gebouwd. De goot\- en bouwhoogte van vrijstaande bijgebouwen zijn gelimiteerd tot 3 en 6 meter.
...
Het ontwerpbestemmingsplan heeft vanaf 28 maart 2018 6 weken als ontwerp ter inzage gelegen. In deze periode is er een zienswijze ingebracht. De gemeente heeft deze zienswijze behandeld. Aan de hand van de zienswijze heeft er Ã©Ã©n ambtshalve aanpassing plaatsgevonden. Het betreft het uitvoeren van een quickscan natuurwaarden op de locatie aan de Potdijk 7\. De quickscan is opgenomen in Bijlage 1. Voor de resultaten wordt verder verwezen naar paragraaf 5\.7. De zienswijzennota is opgenomen in Bijlage 2.
...
Â ![afbeelding "i_NL.IMRO.0200.bp1294-vas1_0004.png"](i_NL.IMRO.0200.bp1294-vas1_0004.png)
...
De nieuwbouw die plaatsvindt, in de vorm van een woning, is passend in de woningbouwprogrammering en afgestemd met de initiatiefnemer.
...
De verkeerssituatie en \-ontsluiting blijft ongewijzigd en loopt via de Veenhuizerweg.
...
* 3\. gebruik van regenwater (in grijswatercircuit of door vegetatiedak);
...
Naast de soortbescherming wordt de gebiedsbescherming geregeld binnen de Natuurbeschermingswet (in de Natura 2000\-gebieden) en binnen het GNN en GO. Bescherming van bos is aan de orde als bestemmingen van bestaand bos worden gewijzigd.
...
Aan het nieuwe woongperceel in dit bestemmingsplan is de gebiedsaanduiding 'wetgevingzone \-
...
Initiatiefnemer heeft, conform de Notitie 'Samen voor kwaliteit, naar een andere ruimtelijke ordening in Apeldoorn', het maatschappelijk draagvlak onderzocht door een informatiebijeenkomst te organiseren. Deze informatiebijeenkomst heeft op 1 juni 2016 plaatsgevonden en de informatieverstrekking door de initiatiefnemer is goed ontvangen door de aanwezigen. De voorgelegde plannen zijn ongewijzigd gebleven en vertaald in dit bestemmingsplan.

#### 7\.3 Ontwerp ter inzage

Het ontwerpbestemmignsplan heeft vanaf 12 janauri 2017 tot en met 22 februari 2017 voor een ter inzage gelegen. Binnen deze termijn heeft een iedere de gelegenheid gehad om een zienswijze in te dienen tegen het plannen. Van deze mogelijkheid is geen gebruik gemaakt. Daarnaast is ook geen zienswijze ingediend door de daarvoor in aanmerking komende instanties.
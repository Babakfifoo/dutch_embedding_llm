...
## **behorende bij wijziging bestemmingsplan Oeffelt ten behoeve van de bouw van een woning op het perceel aan de Stationsweg in Oeffelt**

| 1. | INLEIDING                |                                                                                                                     |                     |  |
|----|--------------------------|---------------------------------------------------------------------------------------------------------------------|---------------------|--|
| 2. | 2.1<br>2.2<br>2.3<br>2.4 | BELEIDSKADER<br>Rijk<br>Provincie<br>Regio<br>Gemeente                                                              | 2<br>3<br>4<br>5    |  |
| 3. | 3.1<br>3.2<br>3.3<br>3.4 | UITVOERINGSASPECTEN<br>Milieuaspecten<br>Fysieke aspecten<br>Economische en financiële aspecten<br>Handhaafbaarheid | 8<br>13<br>16<br>16 |  |
| 4. |                          | ADVIEZEN EN RAPPORTEN                                                                                               | 16                  |  |
...
Een van de bevoegdheden (nummer 6) ligt op het perceel langs de woning Stationsweg 3.

Burgemeester en wethouders zijn bevoegd de bestemming op dit perceel zodanig te wijzigen dat de bouw van een woning mogelijk wordt, mits voldaan is aan de volgende voorwaarden:

- a. het perceel niet meer gelegen is binnen de milieuzone van het bedrijf dat gevestigd is op het perceel Stationsweg 1;
- b. de woning past binnen het gemeentelijk volkshuisvestingsbeleid;
...
Uit een door Peutz uitgevoerd haalbaarheidsonderzoek is gebleken dat het goed mogelijk is de nieuwe woning buiten de milieuzone van het bedrijf op Stationsweg 1 te bouwen. Op voorwaarde b. wordt ingegaan in hoofdstuk 2.4. en op voorwaarde c in hoofdstuk 3.

Op 28 november 2016 heeft de verantwoordelijke wethouder op verzoek van de eigenaar van het perceel besloten gebruik te maken van de wijzigingsbevoegdheid. De resultaten van de hierboven onder c. genoemde onderzoeken zijn beschreven in hoofdstuk 3.
...
### **2.3.2 Regionaal Convenant duurzaam (ver)bouwen Noordoost Brabant**
...
### **2.3.3 Beleidsvisie externe veiligheid gemeenten Land van Cuijk**
...
Artikel 3.1.6, lid 2 van het Besluit ruimtelijke ordening (ladder van duurzame verstedelijking) bepaalt, dat de toelichting bij een bestemmingsplan dat een nieuwe stedelijke ontwikkeling mogelijk maakt, een beschrijving bevat van de behoefte aan die ontwikkeling en, indien het bestemmingsplan die ontwikkeling mogelijk maakt buiten het bestaand stedelijk gebied, een motivering waarom niet binnen het bestaand stedelijk gebied in die behoefte kan worden voorzien.
...
|---------------------|--------|--------------------|--------|---------------|---|-------|
| Groeningen          | -<br>5 | Holthees           | -<br>5 | Maashees      | - | 10    |
| Oeffelt             | - 30   | Overloon           | - 35   | Rijkevoort    | - | 20    |
| Sambeek             | + 50   | Vierlingsbeek - 35 |        | Vortum-Mullem | - | 5.    |

In Oeffelt moeten tot 2027 dus ongeveer 7,8% x 950 = 74 – 30 = 44 woningen gebouwd worden. De harde capaciteit voor Oeffelt bedroeg op 1 januari 2017 slechts 26 woningen (waarvan 1 in aanbouw).

Dit betekent dat zachte plannen voor minimaal 18 woningen hard gemaakt moeten worden. De te bouwen woning aan de Stationsweg staat vermeld op de lijst zachte plannen.

Er is dus geen reden om het verzoek om gebruik te maken van de wijzigingsbevoegdheid af te wijzen.
...
Het plangebied ligt in welstandsvrij gebied met bebouwingstype W9 (individuele woningbouw). Dit blijft voor de nieuwe woning van toepassing..
...
Inrichtingen (Bevi) Altijd wanneer binnen invloedsgebied ruimtelijk besluit wordt genomen. Buisleidingen (Bevb) Altijd wanneer binnen invloedsgebied een ruimtelijk besluit wordt genomen.

- Er kan echter worden volstaan met een beperkte verantwoording wanneer: 1. het groepsrisico lager is dan 0,1 keer de oriëntatiewaarde, of
...
Om de externe veiligheidsrisico's voor het plangebied te inventariseren is de nationale risicokaart geraadpleegd. In de omgeving van het plangebied zijn enkele risicobronnen aanwezig:

- Hoge druk aardgasleiding Z-518-01
- Dorpsstraat/N264 (vervoer gevaarlijke stoffen)

De risico's van de hoge druk aardgasleiding Z-518-01 zijn onderzocht in het rapport 'Kwantitatieve risicoberekening aardgastransportleidingen gemeente Boxmeer'. Ter hoogte van het plangebied heeft de aardgasleiding een PR 10-6 die op de leiding zelf ligt. Het invloedsgebied bedraagt 70 meter. De oriëntatiewaarde (OW) van het groepsrisico wordt niet overschreden. Ook is er geen sprake van een aandachtspunt (lager dan 0,1 OW). De planlocatie bevindt zich in het invloedsgebied, maar omdat er maar één woning is voorzien is de bijdrage aan het groepsrisico verwaarloosbaar. Er dient derhalve een beperkte verantwoording van het groepsrisico te worden opgesteld. Deze volgt verderop in deze paragraaf.

Over de Dorpsstraat worden gevaarlijke stoffen vervoerd. De risico's hiervan zijn onderzocht in het rapport "Inventarisatie vervoer gevaarlijke stoffen" (RMB, 2008). Er is geen PR 10-6 aanwezig en het GR is zeer laag (lager dan 0,1 OW). Omdat het plangebied binnen 200 meter van de weg ligt, is een beperkte verantwoording van het groepsrisico nodig. Overige relevante risicocontouren van inrichtingen, transportroutes (spoor of water) en/of buisleidingen zijn niet aanwezig. Het plan past binnen de aanvullende kaders zoals die zijn vastgelegd in de beleidsvisie externe veiligheid van de gemeente Boxmeer.

#### **Verantwoording groepsrisico**

Vanwege de ligging van het plan in het invloedsgebied van de hoge druk aardgasleiding en de Dorpsstraat/N264 dient een verantwoording van het groepsrisico plaats te vinden.

#### Scenario's

Het plangebied ligt binnen het invloedsgebied van risicobronnen met verschillende scenario's. Relevante scenario's zijn een BLEVE (Dorpsstraat/N264) en een fakkelbrand (hoge druk aardgasleiding). De gevolgen van deze scenario's zijn verschillend. Hieronder worden de scenario's toegelicht.

#### BLEVE (Boiling Liquid Expanding Vapour Explosion)

Een BLEVE is een explosie van een met vloeibaar gas gevulde tankauto. Er bestaat verschil tussen een warme en een koude BLEVE. Van beide varianten kunnen de gevolgen desastreus zijn, maar de impact van een warme BLEVE is groter. Een warme BLEVE is een explosie van een, via een externe bron opgewarmde, tank met vloeibaar gas. Wanneer een tank door bijvoorbeeld een plasbrand wordt opgewarmd kan het gas gaan koken en loopt de druk in de tank zo hoog op dat hij explodeert.

Een koude BLEVE ontstaat door instantaan falen van de tank, bijvoorbeeld door corrosie of beschadiging door een aanrijding. Door de snelle drukverlaging in de tank gaat het gas koken en ontploft de tank. Een externe bron kan deze ontsnapte gaswolk vervolgens doen ontsteken. Fakkelbrand

Bij een hoge druk aardgasleiding kan door schade als gevolg van graafwerkzaamheden boven de buisleiding een fakkelbrand ontstaan. Een fakkelbrand ontstaat wanneer door een externe beschadiging (bijvoorbeeld door graafwerkzaamheden) gas vrijkomt dat vervolgens ontsteekt. Wat volgt is een fakkelbrand die extreme hittestraling kan veroorzaken. Het invloedsgebied van de gasleiding wordt bepaald door de druk en de diameter van de leiding.

De bestrijdbaarheid wordt op twee aspecten beoordeeld:

1. Is het rampscenario te bestrijden?

Een warme BLEVE kan bestreden worden door de hittebron (brand) die de tank opwarmt te bestrijden en/of de tank af te laten koelen. Vanwege de hittewerende coating (waarmee LPGtankauto's zijn uitgerust) kan een warme BLEVE bij LPG-tankauto's praktisch gezien niet meer optreden. Het ontstaan van een koude BLEVE is niet te bestrijden, omdat de tank meteen explodeert. De branden die door de explosie ontstaan kunnen wel bestreden worden. Bij een fakkelbrand moet de leidingbeheerder eerst de gastoevoer afsluiten. Nadat de brand gedoofd is door het afsluiten van de gastoevoer kunnen secundaire branden binnen een afstand van 90 meter geblust worden. De bestrijdbaarheid wordt tijdens de fakkelbrand als slecht beoordeeld. Na het doven van de fakkelbrand is de bestrijdbaarheid goed.

2. Is de omgeving voldoende ingericht om bestrijding te faciliteren?

Zowel in het geval van een BLEVE als een fakkelbrand is het plangebied goed bereikbaar en zijn er voldoende opstelplaatsen voor de brandweer.

Zelfredzaamheid is het zichzelf kunnen onttrekken aan een dreigend gevaar, zonder daadwerkelijke hulp van hulpdiensten. Het zelfredzame vermogen van personen is een belangrijke voorwaarde om grote calamiteiten bij een incident te voorkomen. De mogelijkheden voor zelfredzaamheid bestaan globaal uit vluchten en schuilen en zijn afhankelijk van het maatgevende scenario.

### 1. Mogelijkheden zelfredzaamheid

De mogelijkheden t.a.v. zelfredzaamheid zijn goed. Er zijn geen aanwijzingen dat een (grote) groep niet – of verminderd – zelfredzame personen in het plangebied (zullen) verblijven. De aanwezigen zijn naar verwachting voldoende mobiel om zelfstandig te kunnen vluchten.

2. Is het gebied voldoende ingericht om de zelfredzaamheid te kunnen faciliteren? Behalve de vraag of zelfredzaamheid mogelijk is, zijn de fysieke eigenschappen van gebouwen en omgeving van invloed op de vraag of die zelfredzaamheid optimaal kan plaatsvinden. In geval van een calamiteit kan NL-alert worden ingezet. NL-Alert is een alarmmiddel van de overheid voor de mobiele telefoon. Hiermee kunnen mensen in de directe omgeving van een noodsituatie met een tekstbericht worden geïnformeerd. In het bericht staat specifiek wat er aan de hand is en wat je op dat moment het beste kunt doen (vluchten of schuilen).

Voor externe ontvluchting van het plangebied is een goede infrastructuur van belang waarbij van de bron af gevlucht kan worden. In de omgeving van het plangebied zijn voldoende wegen voorhanden om van de Dorpsstraat/N264 af te vluchten.

Bij een fakkelbrand is de afstand van belang voor het handelingsperspectief (vluchten of schuilen). Indien de fakkelbrand binnen een afstand van 70 meter van de woning plaatsvindt, zal de woning ontbranden en ontvlucht moeten worden. Tot een afstand van 70 meter biedt de woning echter wel bescherming tegen de hoge hittestraling, waardoor de kans op ernstig letsel beperkt wordt. Bij de verdere planvorming zal de initiatiefnemer worden gewezen op dit handelingsperspectief.

### **Conclusie**

De beoogde ontwikkeling voldoet aan de grenswaarde voor het plaatsgebonden risico en aan de kaders die zijn vastgelegd in de beleidsvisie externe veiligheid van de gemeente Boxmeer. Het plangebied ligt binnen het invloedsgebied van hoge druk aardgasleiding Z-518-01 en de Dorpsstraat/N264. Het groepsrisico is verantwoord en wordt aanvaardbaar geacht. De volgende overwegingen spelen daarbij een rol:
...
In onderhavig geval is sprake van de bouw van één woning en daarom kan gesproken worden van een Niet-in-betekenende-mate (NIBM) bijdrage aan de verslechtering van de luchtkwaliteit.
...
Het perceel ligt in Archeologische onderzoeksgebied A, zodat de dubbelbestemming Waarde – archeologie 3 van toepassing is.
...
Tijdens een door Natuurkompas uitgevoerd onderzoek zijn geen strikt beschermde soorten aangetroffen. Mogelijk fungeren de eiken in de omringende groensingel als foerageergebied van de eekhoorn en de weide kan fungeren als marginaal foerageergebied van de das. In beide gevallen geldt dat er in de directe omgeving voldoende kwalitatief beter alternatief foerageergebied voorhanden is.

Om te voorkomen dat broedende vogels verstoord worden en/of nesten worden aangetast, moeten de werkzaamheden buiten het broedseizoen (grofweg van 15 maart tot 15 juli) worden uitgevoerd.

### **3.2.3 Leidingen**

Onder de Stationsweg ligt een gastransportleiding, die met een dubbelbestemming in het vigerend plan Oeffelt opgenomen is. Deze dubbelbestemming heeft een breedte van 4 meter aan weerszijden van de leiding. Door aankoop van een strook grond ligt het voorste deel van het plangebied binnen de zone van de leiding. Daarom ligt op dit deel de dubbelbestemming Leiding – Gas.

#### **3.2.4 Verkeer en parkeren**

Het perceel ligt aan het gedeelte van de Stationsweg dat gecategoriseerd is als erftoegangsweg binnen de bebouwde kom. De maximumsnelheid bedraag 30km/h. Vanuit een oogpunt van verkeer is er geen bezwaar tegen het bouwen van de woning. Op eigen terrein moeten minimaal twee parkeerplaatsen worden aangelegd.
...
- Haalbaarheids(geluid)onderzoek d.d. 20 september 2016, Peutz
- Flora- en faunaquickscan d.d. september 2016, Natuurkompas.
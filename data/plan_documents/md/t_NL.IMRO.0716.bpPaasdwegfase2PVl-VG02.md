...
Afbeelding 1: Ligging van het plangebied (bron: google.nl/maps).
...
Afbeelding 5: Het plangebied in de directe omgeving (bron: Google Maps).
...
|                                             | compenserende maatregelen benodigd zijn.      |  |  |
...
<span id="page-30-0"></span><sup>7</sup> BAAC, Gemeente Tholen Plangebied Paasdijkweg/Lageweg te Poortvliet; Inventariserend
...
| meer dan:                                 |                                                                                                                                                          |                                                                                                            |                                                                                                                                                                                                                              |
| a. goothoogte                             | zie aanduiding<br>'maximum goot-<br>en<br>bouwhoogte (m)'                                                                                                | 3 m                                                                                                        | niet van toepassing                                                                                                                                                                                                          |
| b. bouwhoogte                             | -<br>gebouwen voor<br>nutsvoorzieningen: 3<br>m<br>-<br>voor het overige:<br>zie<br>aanduiding 'maximum<br>goothoogte (m),<br>maximum<br>bouwhoogte (m)' | -<br>overkapping: 3 m<br>-<br>gebouwen:<br>maximale<br>goothoogte<br>3<br>m,<br>maximale<br>bouwhoogte 6 m | -<br>muren en<br>terreinafscheidingen<br>achter de voorgevel<br>van hoofdgebouwen:<br>2 m;<br>-<br>muren en<br>terreinafscheidingen<br>voor de voorgevel van<br>hoofdgebouwen: 1 m;<br>-<br>licht-<br>en<br>vlaggenmasten en |

- d: voor het overige geldt:

|                         |                        |                     | antennemasten: 9 m;<br>-<br>schotelantennes 6<br>m;<br>-<br>speel-<br>en<br>spelvoorzieningen in<br>openbaar gebied: 5<br>m;<br>-<br>overig bouwwerk,<br>geen gebouw zijnde: 3<br>m |
|-------------------------|------------------------|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4. de oppervlakte       |                        |                     |                                                                                                                                                                                     |
| bedraagt niet meer dan: |                        |                     |                                                                                                                                                                                     |
| a. binnen een bouwvlak  | -<br>gebouwen voor     | per bouwperceel     | niet gemaximeerd                                                                                                                                                                    |
|                         | nutsvoorzieningen: 15  | 75% (inclusief      |                                                                                                                                                                                     |
|                         | m2                     | hoofdgebouw)        |                                                                                                                                                                                     |
|                         | -<br>voor het overige: |                     |                                                                                                                                                                                     |
|                         | per bouwperceel 75%    |                     |                                                                                                                                                                                     |
|                         | (inclusief aan-<br>en  |                     |                                                                                                                                                                                     |
...
- c. geen inbreuk wordt gemaakt op het bepaalde in lid 3.2 sub d.4 ten aanzien van het maximaal te bebouwen gedeelte van de gronden.
...
#### *3.4.2 Uitoefening andere activiteiten in woningen*
...
- b. binnen een afstand van 100 tot 400 m tot het middelpunt van de molen wordt geen bebouwing opgericht met een bouwhoogte die meer bedraagt dan 1/50 van de afstand van het bouwwerk tot het middelpunt van de molen "De Korenaar", gerekend vanaf de onderste punt van de verticaal staande wiek;
- c. in afwijking van het bepaalde onder a en b is bebouwing met een grotere bouwhoogte in de volgende gevallen rechtstreeks toegestaan:
	...
	- 3. het betreft een bouwwerk dat voldoet aan de bouwhoogte, zoals opgenomen op de verbeelding van dit bestemmingsplan.

#### *6.1.3 Uitvoeringsverbod zonder omgevingsvergunning voor het uitvoeren van werken, geen bouwwerk zijnde, of van werkzaamheden*

Het is verboden ter plaatse van de aanduiding 'vrijwaringszone - molenbiotoop' binnen een afstand van 100 m tot het middelpunt van de in lid 6.1.2 genoemde molen zonder of in afwijking van een omgevingsvergunning de volgende werken of werkzaamheden uit te voeren:

- a. het beplanten met bomen, heesters en andere hoog opgaande beplanting;
- b. het ophogen van gronden.

#### *6.1.4 Uitzonderingen op het uitvoeringsverbod*

Het verbod van lid 6.1.3 is niet van toepassing op werken of werkzaamheden die:
...
Deze regels worden aangehaald als: 'Regels van het bestemmingsplan Paasdijkweg fase 2, Poortvliet', gemeente Tholen.

# **STAAT VAN BEDRIJFSACTIVITEITEN FUNCTIEMENGING**

Lijst van gebruikte afkortingen in de Staat van Bedrijfsactiviteiten 'functiemenging'
...
|---------------|---------------|----------------|------------------------------------------------------------------------------------------------|-----------|
| -             |               | mer<br>m<br>nu |                                                                                                | CATEGORIE |
| 01            | 01            | -              | LANDBOUW EN DIENSTVERLENING T.B.V. DE LANDBOUW                                                 |           |
| 014           | 016           | 0              | Dienstverlening t.b.v.<br>de landbouw:                                                         |           |
| 014           | 016           | 2              | -<br>algemeen (o.a. loonbedrijven), b.o < 500 m²                                               | B1        |
| 014           | 016           | 4              | -<br>plantsoenendiensten en hoveniersbedrijven, b.o. < 500 m²                                  | B1        |
|               |               |                |                                                                                                |           |
| 15            | 10, 11        | -              | VERVAARDIGING VAN VOEDINGSMIDDELEN EN DRANKEN                                                  |           |
| 151           | 101, 102      | 0              | Slachterijen en overige vleesverwerking:                                                       |           |
| 151           | 101           | 6              | -<br>vleeswaren-<br>en vleesconservenfabrieken, p.o. < 200 m²                                  | B2        |
| 1552          | 1052          | 2              | Consumptie-ijsfabrieken, p.o. < 200<br>m²                                                      | B1        |
| 1581          | 1071          | 1              | Broodfabrieken, brood-<br>en banketbakkerijen, charge-ovens,<br>v.c.< 7.500 kg meel/week       | B1        |
| 1584          | 10821         | 0              | Verwerking cacaobonen en vervaardiging chocolade-<br>en<br>suikerwerk:                         |           |
| 1584          | 10821         | 3              | -<br>Cacao-<br>en chocoladefabrieken-<br>vervaardigen van<br>chocoladewerken met p.o. < 200 m² | B1        |
| 1584          | 10821         | 6              | -<br>Suikerwerkfabrieken zonder suiker branden, p.o. < 200 m²                                  | B1        |
| 1593 t/m 1595 | 1102 t/m 1104 |                | Vervaardiging van wijn, cider e.d.                                                             | B1        |
|               |               |                |                                                                                                |           |
| 17            | 13            | -              | VERVAARDIGING VAN TEXTIEL                                                                      |           |
| 174, 175      | 139           |                | Vervaardiging van textielwaren                                                                 | B2        |
| 176, 177      | 139, 143      |                | Vervaardiging van gebreide en gehaakte stoffen<br>en artikelen                                 | B2        |
|               |               |                |                                                                                                |           |
| 18            | 14            | -              | VERVAARDIGING VAN KLEDING; BEREIDEN EN VERVEN VAN<br>BONT                                      |           |
| 181           | 141           |                | Vervaardiging kleding van leer                                                                 | B2        |
| 182           | 141           |                | Vervaardiging van kleding en -toebehoren (excl. van leer)                                      | C         |
|               |               |                |                                                                                                |           |
| 20            | 16            | -              | HOUTINDUSTRIE EN VERVAARDIGING ARTIKELEN VAN<br>HOUT, RIET, KURK E.D.                          |           |
| 203, 204, 205 | 162           | 1              | Timmerwerkfabrieken, vervaardiging overige artikelen van<br>hout, p.o. < 200 m2                | B2        |
| 205           | 162902        |                | Kurkwaren-, riet-<br>en vlechtwerkfabrieken                                                    | B1        |
|               |               |                |                                                                                                |           |
| 22            | 58            | -              | UITGEVERIJEN, DRUKKERIJEN EN REPRODUKTIE VAN<br>OPGENOMEN MEDIA                                |           |
...
| VERVAARDIGING VAN GLAS, AARDEWERK, CEMENT-, KALK<br>26<br>23<br>-<br>EN GIPSPRODUKTEN<br>2612<br>2312<br>Glas-in-lood-zetterij<br>2615<br>231<br>Glasbewerkingsbedrijven<br>262, 263<br>232, 234<br>0<br>Aardewerkfabrieken: | B1<br>B2<br>B1<br>B2<br>B2 |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|
|                                                                                                                                                                                                                              |                            |
|                                                                                                                                                                                                                              |                            |
|                                                                                                                                                                                                                              |                            |
...
|                                                                                                                                                                                                                              |                            |
|                                                                                                                                                                                                                              |                            |
| 262, 263<br>232, 234<br>1<br>-<br>vermogen elektrische ovens totaal < 40 kW                                                                                                                                                  |                            |
| 267<br>237<br>0<br>Natuursteenbewerkingsbedrijven:                                                                                                                                                                           |                            |
| 267<br>237<br>2<br>-<br>zonder breken, zeven en drogen p.o.<br>< 2.000 m²                                                                                                                                                    |                            |
| 2681<br>2391<br>Slijp-<br>en polijstmiddelen fabrieken                                                                                                                                                                       |                            |
|                                                                                                                                                                                                                              |                            |
| VERVAARD. EN REPARATIE VAN PRODUKTEN VAN METAAL                                                                                                                                                                              |                            |
| 28<br>25<br>-<br>(EXCL. MACH./TRANSPORTMIDD.)                                                                                                                                                                                |                            |
| 281<br>251, 331<br>1a<br>-<br>gesloten gebouw, p.o. < 200 m2                                                                                                                                                                 | B2                         |
| Smederijen, lasinrichtingen, bankwerkerijen e.d., p.o. < 200                                                                                                                                                                 |                            |
| 284<br>255, 331<br>B1<br>m2                                                                                                                                                                                                  | B2                         |
| Overige metaalbewerkende industrie, inpandig, p.o.                                                                                                                                                                           |                            |
| 2852<br>2562, 3311<br>2<br><200m2                                                                                                                                                                                            | B2                         |
| Overige metaalwarenfabrieken n.e.g.; inpandig, p.o. <200                                                                                                                                                                     |                            |
| 287<br>259, 331<br>B<br>m2                                                                                                                                                                                                   | B2                         |
|                                                                                                                                                                                                                              |                            |
| 30<br>26, 28, 33<br>-<br>VERVAARDIGING VAN KANTOORMACHINES EN COMPUTERS                                                                                                                                                      |                            |
| 30<br>26, 28, 33<br>A<br>Kantoormachines-<br>en computerfabrieken incl. reparatie                                                                                                                                            | B1                         |
|                                                                                                                                                                                                                              |                            |
| VERVAARDIGING VAN MEDISCHE EN OPTISCHE APPARATEN                                                                                                                                                                             |                            |
| 33<br>26, 32, 33<br>-<br>EN INSTRUMENTEN                                                                                                                                                                                     |                            |
| Fabrieken voor medische en optische apparaten en                                                                                                                                                                             |                            |
| 33<br>26, 32, 33<br>A<br>instrumenten e.d. incl. reparatie                                                                                                                                                                   | B1                         |
|                                                                                                                                                                                                                              |                            |
| VERVAARDIGING VAN MEUBELS EN OVERIGE GOEDEREN                                                                                                                                                                                |                            |
| 36<br>31<br>-<br>N.E.G.                                                                                                                                                                                                      |                            |
| 361<br>9524<br>2<br>Meubelstoffeerderijen b.o. < 200 m2                                                                                                                                                                      | A                          |
| 362<br>321<br>Fabricage van munten, sieraden e.d.                                                                                                                                                                            | B1                         |
| 363<br>322<br>Muziekinstrumentenfabrieken                                                                                                                                                                                    | B1                         |
| 3663.1<br>32991<br>Sociale werkvoorziening                                                                                                                                                                                   | B1                         |
|                                                                                                                                                                                                                              |                            |
| PRODUKTIE EN DISTRIB. VAN STROOM, AARDGAS, STOOM                                                                                                                                                                             |                            |
| 40<br>35<br>-<br>EN WARM WATER                                                                                                                                                                                               |                            |
| Elektriciteitsdistributiebedrijven, met                                                                                                                                                                                      |                            |
| 40<br>35<br>C0<br>transformatorvermogen:                                                                                                                                                                                     |                            |
| 40<br>35<br>C1<br>-<br>< 10 MVA                                                                                                                                                                                              | B1                         |
| 40<br>35<br>D0<br>Gasdistributiebedrijven:                                                                                                                                                                                   |                            |
| 40<br>35<br>D3<br>-<br>gas: reduceer-, compressor-, meet-<br>en regelinst. Cat. A                                                                                                                                            | A                          |
| -<br>gasdrukregel-<br>en meetruimten (kasten en gebouwen), cat.                                                                                                                                                              |                            |
| 40<br>35<br>D4<br>B en C                                                                                                                                                                                                     | B1                         |
| 40<br>35<br>E0<br>Warmtevoorzieningsinstallaties, gasgestookt:                                                                                                                                                               |                            |
| 40<br>35<br>E2<br>-<br>blokverwarming                                                                                                                                                                                        | B1                         |
|                                                                                                                                                                                                                              |                            |
| 41<br>36<br>-<br>WINNING EN DITRIBUTIE VAN WATER                                                                                                                                                                             |                            |
...
|               |               |    | Aannemersbedrijf of bouwbedrijf<br>met werkplaats, b.o. <     | B1 |
| 45            | 41, 42, 43    | 3  | 1000 m2                                                       |    |
| 453           | 432           |    | Bouwinstallatie<br>algemeen (exclusief spuiterij)             | B1 |
| 453           | 4321          |    | Elektrotechnische installatie                                 | B1 |
|               |               |    |                                                               |    |
|               |               |    | HANDEL/REPARATIE VAN AUTO'S, MOTORFIETSEN;                    |    |
| 50            | 45, 47        | -  | BENZINESERVICESTATIONS                                        |    |
|               |               |    | Handel in auto's en motorfietsen, reparatie-<br>en            | B1 |
| 501, 502, 504 | 451, 452, 454 |    | servicebedrijven<br>(exclusief plaatwerkerij of spuiterij)    |    |
| 5020.4        | 45204         | B  | Autobeklederijen                                              | A  |
| 5020.5        | 45205         |    | Autowasserijen                                                | B1 |
| 503, 504      | 453           |    | Handel in auto-<br>en motorfietsonderdelen en -accessoires    | B1 |
|               |               |    |                                                               |    |
...
| 5148.7        | 46499         | 1  | -<br>consumentenvuurwerk, verpakt, opslag < 10 ton            | C  |
| 5153          | 4673          | 0  | Grth in hout en bouwmaterialen:                               |    |
| 5153          | 5153          | 1  | algemeen: b.o. > 2.000 m2<br>-                                | C  |
| 5153          | 4673          | 2  | indien b.o. =< 2.000 m2<br>-                                  | B1 |
| 5153.4        | 5153.4        | 4  | zand en grind:                                                |    |
| 5153.4        | 46735         | 6  | -<br>indien b.o. =< 200 m²                                    | B1 |
| 5154          | 4674          | 0  | Grth in ijzer-<br>en metaalwaren en verwarmingsapparatuur:    |    |
| 5154          | 5154          | 1  | algemeen: b.o. > 2.000 m2<br>-                                | C  |
| 5154          | 4674          | 2  | -<br>indien b.o. =<<br>2.000 m²                               | B1 |
| 5156          | 4676          |    | Grth in overige intermediaire goederen                        | C  |
|               |               |    | Grth in machines en apparaten, opp. >= b.o. 2.000 m2          | C  |
| 518           | 466           | 2  | exclusief machines voor de bouwnijverheid                     |    |
|               |               |    | Grth in machines en apparaten, opp. >= b.o. 2.000 m2          | B1 |
| 518           | 466           |    | exclusief machines voor de bouwnijverheid                     |    |
|               |               |    | Overige grth (bedrijfsmeubels, emballage,                     | C  |
| 519           | 466,<br>469   |    | vakbenodigdheden e.d.)                                        |    |
|               |               |    |                                                               |    |
...
|               |               |    | Goederenwegvervoerbedrijven (zonder schoonmaken               | C  |
| 6024          | 494           | 1  | tanks), b.o. =< 1.000 m²                                      |    |
| 603           | 495           |    | Pomp-<br>en compressorstations van pijpleidingen              | B1 |
|               |               |    |                                                               |    |

| 63     | 52              | - | DIENSTVERLENING T.B.V. HET VERVOER                         |    |
|--------|-----------------|---|------------------------------------------------------------|----|
| 6321   | 5221            |   | Caravanstalling                                            | B1 |
|        |                 |   |                                                            |    |
| 64     | 53              | - | POST EN TELECOMMUNICATIE                                   |    |
| 641    | 531, 532        |   | Post-<br>en koeriersdiensten                               | C  |
|        |                 |   |                                                            |    |
|        |                 |   | VERHUUR VAN TRANSPORTMIDDELEN, MACHINES, ANDERE            |    |
| 71     | 77              | - | ROERENDE GOEDEREN                                          |    |
| 711    | 7711            |   | Personenautoverhuurbedrijven                               | B2 |
|        |                 |   | Verhuurbedrijven voor transportmiddelen (excl.             | C  |
| 712    | 7712, 7739      |   | personenauto's)                                            |    |
| 713    | 773             |   | Verhuurbedrijven voor machines en werktuigen               | C  |
|        |                 |   |                                                            |    |
| 72     | 62              | - | COMPUTERSERVICE-<br>EN INFORMATIETECHNOLOGIE               |    |
| 72     | 62              | A | Computerservice-<br>en informatietechnologie-bureau's e.d. | A  |
| 72     | 58, 63          | B | Datacentra                                                 | B1 |
|        |                 |   |                                                            |    |
| 73     | 72              | - | SPEUR-<br>EN ONTWIKKELINGSWERK                             |    |
| 732    | 722             |   | Maatschappij-<br>en geesteswetenschappelijk onderzoek      | A  |
|        |                 |   |                                                            |    |
|        | 63, 69t/m71,    |   |                                                            |    |
|        | 73, 74, 77, 78, |   |                                                            |    |
| 74     | 80t/m82         | - | OVERIGE ZAKELIJKE DIENSTVERLENING                          |    |
| 7481.3 | 74203           |   | Foto-<br>en filmontwikkelcentrales                         | C  |

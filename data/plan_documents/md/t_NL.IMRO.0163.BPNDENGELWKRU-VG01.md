*Oktober 2018 Vastgesteld*

# *Bestemmingsplan*

# *"Bestemmingsplan Engelwortel Kruidenwijk"*

Status: Vastgesteld Datum: Oktober 2018

Bestemmingsplan: "Bestemmingsplan Engelwortel Kruidenwijk" IDN: NL.IMRO.0163.BPNDENGELWKRU-VG01

**Bestemmingsplan Engelwortel Kruidenwijk** Vastgesteld
...
| 2.1               | HET PLANGEBIED EN DE OMGEVING 8           |    |
...
| HOOFDSTUK 6       | WATERASPECTEN<br>                         | 34 |
| 6.1               | ALGEMEEN34                                |    |
...
| HOOFDSTUK 9       | VOOROVERLEG EN INSPRAAK<br>               | 44 |
| 9.1               | VOOROVERLEG44                             |    |
| 9.2               | INSPRAAK44                                |    |
| 9.3               | ZIENSWIJZEN44                             |    |
...
Aan de Engelwortel, gelegen binnen de Kruidenwijk in de gemeente Hellendoorn, ligt een onbebouwd perceel met een woonbestemming. Initiatiefnemer is voornemens om op dit perceel een twee-onder-een-kapwoning te realiseren. De gemeente Hellendoorn staat positief tegenover het initiatief onder de voorwaarde dat de twee woningen worden gebouwd met een lage goot.

Voorliggend initiatief is niet in overeenstemming met het geldende bestemmingsplan aangezien ter plaatse van het plangebied sprake is van een maximale maatvoering waardoor het enkel is toegestaan om één wooneenheid te realiseren. De afwijkingsmogelijkheden binnen het geldende bestemmingsplan bieden geen uitkomst.

Om op deze locatie twee woningen te kunnen bouwen is herziening van het bestemmingsplan noodzakelijk. Voorliggend bestemmingsplan voorziet hierin. Er zal worden aangetoond dat het gewenste plan vanuit ruimtelijk en planologisch oogpunt verantwoord is.

# <span id="page-4-2"></span>**1.2 Ligging van het plangebied**

Het plangebied bevindt zich aan de Engelwortel in de tot Nijverdal behorende Kruidenwijk, ten zuidoosten van de kern Hellendoorn. In figuur 1.1 is de ligging van het plangebied ten opzichte van de kern Hellendoorn en ten opzichte van de directe omgeving weergegeven.

<span id="page-4-3"></span>*Figuur 1.1 Ligging van het plangebied ten opzichte van Hellendoorn en ten opzichte van de directe omgeving (Bron: ArcGIS)*

# **1.3 De bij het plan behorende stukken**

Het "Bestemmingsplan Engelwortel Kruidenwijk' bestaat uit de volgende stukken:

- verbeelding (tek. Nr. NL.IMRO.0163.BPNDENGELWKRU-VG01) en een renvooi;
...
De locatie is gelegen binnen het bestemmingsplan "Nijverdal Noordoost Kruidenwijk-Hulsen" van de gemeente Hellendoorn. Dit bestemmingsplan is vastgesteld door de gemeenteraad van Hellendoorn op 18 juni 2013. Op basis van het huidige bestemmingsplan geldt voor het volledige perceel de bestemming 'Wonen - 1'

In figuur 1.2 is een uitsnede van het bestemmingsplan ter plaatse van het plangebied opgenomen, het beoogde plangebied is rood omlijnd weergegeven.

*Figuur 1.2 Uitsnede geldend bestemmingsplan "Nijverdal Noordoost Kruidenwijk - Hulsen" (Bron: gemeente Hellendoorn)*

# **1.4.2 Beschrijving bestemmingen**

Gronden met de bestemming 'Wonen' zijn bestemd voor wonen, aan huis verbonden beroepen en water. Het plangebied is grotendeels gelegen binnen een bouwvlak.

Binnen dit bouwvlak mogen op basis van de geldende bouwregels vrijstaande woningen, of ten hoogste het bestaande aantal aaneen gebouwde woningen worden gebouwd dan wel tot het aantal dat is aangeduid in het bouwvlak. In dit geval is er ten aanzien van het bouwvlak sprake van een maatvoering van toepassing. Deze maatvoering bepaald het maximaal aantal wooneenheden binnen het perceel tot één.

# **1.4.3 Strijdigheid**

Initiatiefnemer is voornemens een twee-onder-een-kapwoning te realiseren binnen een perceel waar enkel de realisatie van één wooneenheid is toegestaan.

Om het initiatief mogelijk te maken dient het bestemmingsplan herzien te worden, zodat het is toegestaan binnen het plangebied twee woningen te realiseren. Voorliggend bestemmingsplan voorziet hierin.

# <span id="page-6-0"></span>**1.5 Leeswijzer**

Na deze inleiding wordt in hoofdstuk 2 een beschrijving van de historische ontwikkeling van Hellendoorn en een beschrijving van de huidige situatie in het plangebied en omliggend gebied gegeven.
...
# **2.1 Het plangebied en de omgeving**

Het plangebied bevindt zich in de met het dorp Hulsen versmolten Kruidenwijk. Deze wijk is onderdeel van het dorp Nijverdal, dat de grootste kern van de gemeente Hellendoorn is. De ruimtelijk-functionele structuur bestaat uit een woongebied met verspreide groenstroken.

Het plangebied is in de huidige situatie onbebouwd en bestaat uit grasland.

Het plangebied wordt aan de noordelijke kant begrensd door de straat Engelwortel en aan de overige zijden door woonpercelen. In figuur 2.1 en figuur 2.2 zijn luchtfoto's en straatbeelden van het plangebied weergegeven.

*Figuur 2.1 Omgeving van het plangebied (Bron: Provincie Overijssel)*
...
<span id="page-8-2"></span>De initiatiefnemer is voornemens binnen het nu onbebouwde plangebied een dubbelwoning te realiseren.

# **3.2 Bebouwing**

Het plangebied beslaat een oppervlak van circa 750 m². De bebouwing zal inclusief aan- en uitbouw, overkappingen en erfverharding circa 250 m² beslaan. Voor de situering van de twee-onder-een-kapwoning is rekening gehouden met de zichtlijnen vanuit en richting de woonwijk. De voorgevels van de woningen worden gesitueerd parallel aan de Engelwortel. Dit is in lijn met de overige woningen aan de Engelwortel. Daarnaast is rekening gehouden met de bestaande rooilijn van de naastgelegen woning aan de Engelwortel.

Qua bouwstijl zal worden aangesloten bij de architectonische stijl van de omringende woningen ten behoeve van de landschappelijke inpassing in het gebied. Hierbij wordt opgemerkt dat er in de directe omgeving van het plangebied al sprake is van dubbele woningen. De voorliggende ontwikkeling past in die zin goed binnen de omgeving. In de figuren 3.1 en 3.2 zijn enkele impressieafbeeldingen opgenomen van het huidige bouwkundig ontwerp.

*Figuur 3.1 3D impressie dubbelwoning en plaatsing binnen het plangebied (Bron: Madmax Diesajn)*

<span id="page-9-0"></span>*Figuur 3.2 Impressie aangezichten dubbelwoning (Bron: Madmax Diesajn)* 
...
Binnen de begrenzing van het plangebied wordt de realisatie van twee woningen (twee-onder-eenkapwoningen) mogelijk gemaakt. De Nota Parkeernormen maakt onderscheid tussen parkeren in het centrum van Nijverdal en parkeren in overige delen van de gemeente Hellendoorn. Op basis van de Nota Parkeernormen geldt voor het plangebied 'overig deel gemeente' voor het woningtype 'twee-onder-een-kap', een parkeernorm van 2,1 parkeerplaats per woning.

Omdat de Nota parkeernormen niets zegt over verkeersgeneratie is hiervoor uitgegaan van de cijfers van het CROW. In dit geval brengt een twee-onder-een-kapwoning per wooneenheid een verkeersgeneratie met zich mee van 7,8 verkeersbewegingen per weekdagetmaal (rest bebouwde kom, weinig stedelijk).

# *3.3.2.2 Berekening parkeerbehoefte*

In voorliggend geval worden twee woningen, zijnde twee-onder-een-kapwoningen, gerealiseerd. Hiermee is sprake van een parkeerbehoefte van 4,2 parkeerplaatsen (2,1 + 2,1) binnen het plangebied. Gelet op de omvang van het perceel is er voldoende ruimte om op eigen erf in de parkeerbehoefte te voorzien.

# *3.3.2.3 Berekening verkeersgeneratie*

Gezien de voorgenomen ontwikkeling is er sprake van een toename van de verkeersgeneratie van 15,6 (7,8 + 7,8) verkeersbewegingen per weekdagetmaal. Beide woningen krijgen een eigen in- en uitrit welke worden ontsloten op de Engelwortel. Ten aanzien van de verkeersgeneratie wordt gesteld dat er slechts sprake is van een zeer beperkte toename van het aantal verkeersbewegingen. De Engelwortel kan deze toename van de verkeersgeneratie eenvoudig afwikkelen. Hierbij wordt nog opgemerkt dat de huidige bestemming voorziet in de mogelijkheid van de bouw van één woning waardoor er planologisch gezien slechts sprake is van een toename van één woning met de bijbehorende beperkte toename van de verkeersgeneratie.
...
Het plangebied is gelegen binnen het bij Nijverdal behorende dorp Hulsen en het betreft een binnenstedelijke ontwikkeling die voldoet aan het principe van 'Zuinig en zorgvuldig ruimtegebruik'. Met de ontwikkeling wordt feitelijk invulling gegeven aan de bestaande woonbestemming. Er vindt geen extra ruimtebeslag plaats op de groene omgeving. In verband hiermee is het voorliggende bestemmingsplan in overeenstemming met artikel 2.1.3 uit de Omgevingsverordening Overijssel.
...
Binnen gebieden met het ontwikkelingsperspectief 'Woon- en werklocaties buiten de stedelijke netwerken' is ruimte voor herstructurering, inbreiding en transformatie. In voorliggend geval wordt een twee-onder-eenkapwoning gerealiseerd. Door de ontwikkeling wordt binnen het bestaand stedelijk gebied voorzien in een beperkt deel van de lokale woningbehoefte in de kern Hulsen. Doordat het plangebied is aangemerkt als woon- en werklocatie is van ruimtebeslag op de groene omgeving tevens geenszins sprake. Geconcludeerd wordt dat het ontwikkelingsperspectief 'Woon- en werklocaties buiten de stedelijke netwerken' zich niet verzet tegen de voorgenomen herontwikkeling.
...
Omdat prognoses gepaard gaan met enige onzekerheid maken de gemeenten in Twente de afspraak te werken met een bandbreedte. Zowel de onderkant als de bovenkant van de bandbreedte hebben waarde. Dit voorkomt blindstaren op één getal en helpt gemeenten in Twente een stap te zetten naar meer kwalitatief en

adaptief programmeren. De bovenkant van de bandbreedte kan worden opgezocht onder de volgende voorwaarden:
...
De welstandsnota is opgebouwd uit verschillende deelgebieden. Onderhavig plangebied is gelegen in gebied 5: "Planmatige bebouwing". In dit gebied gelden de volgende specifieke welstandscriteria:

# Situering

- Bestaande rooilijn respecteren
- Nokrichting overeenkomstig omliggende bebouwing
- Bijgebouwen ondergeschikt aan hoofdgebouw
- Oriëntatie op openbare weg
...
- Kleur en materiaalgebruik overeenkomstig omliggende
- bebouwing
- Bijgebouwen in architectuur hoofdgebouw
...
Op basis van de huidige bouwtekeningen en ontwerpen kan worden gesteld dat aan veel van de gestelde welstandcriteria wordt voldaan. De definitieve ontwerpen worden in het kader van de aanvraag voor de omgevingsvergunning voor het bouwen getoetst aan de welstandscriteria.
...
In dit geval is sprake van nieuwbouw van geluidsgevoelige objecten, namelijk twee woningen.

# *5.1.2.1 Industrielawaai*

In de nabijheid van het plangebied zijn geen industriële inrichtingen of gezoneerde industrieterreinen aanwezig. In paragraaf 5.5 wordt nader ingegaan op milieuhinder (o.a. geluid) als gevolg van individuele bedrijven. Het aspect industrielawaai vormt geen belemmering voor dit bestemmingsplan.

# *5.1.2.2 Railverkeerslawaai*

Railverkeerslawaai wordt in dit geval buiten beschouwing gelaten omdat de dichtstbijzijnde spoorlijn op voldoende afstand, ruim 1,5 kilometer, van het plangebied is gelegen en het plangebied daarom niet valt binnen een wettelijke geluidszone van railverkeerslawaai.
...
In dit geval zijn er ter plaatse van de huidige bebouwingen in het dorp Hulsen geen bodemverontreinigingen bekend. Uit de toelichting behorende bij het geldende bestemmingsplan blijkt dat de gemeente Hellendoorn ervan uit is gegaan dat er, ten aanzien van de vaststelling van het geldende bestemmingsplan en de eventuele ontwikkeling en realisatie van de aanleg van infrastructuur en woningen, geen sprake was van enige ruimtelijke beperkingen. De bekende gegevens van de uitgevoerde bodemonderzoeken worden voldoende dekkend geacht voor een afdoende inzicht in de heersende bodemkwaliteit binnen het plangebied.

Gezien de locatie van het plangebied binnen het dorp Hulsen en de daar bekende bodemkwaliteit wordt gesteld dat er voor de realisatie van dit plan geen verkennend bodemonderzoek noodzakelijk is.
...
Voorliggend bestemmingsplan voorziet in een ontwikkeling van het plangebied waarbij twee woningen worden gerealiseerd. Een project met een dergelijke omvang is aan te merken als een project welke "niet in betekenende mate bijdraagt" aan luchtverontreiniging.
...
Het plangebied aan de Engelwortel is gelegen in een woonwijk die is ingericht volgens het principe van functiescheiding waar overige functies vrijwel niet voorkomen. Daarom wordt in dit geval uitgegaan van het omgevingstype "rustige woonwijk".
...
Binnen een straal van ruim 180 meter rondom het plangebied, zijn geen milieubelastende functies aanwezig. In de directe omgeving van het plangebied zijn geen functie aanwezig die een belemmering vormen voor de voorgenomen woningen. Ter plaatse van de woningen wordt een goed woon- een leefklimaat verwacht.
...
Het plangebied aan de Engelwortel is niet gelegen binnen een Natura 2000-gebied in het kader van de Wet natuurbescherming. Zoals te zien is in figuur 5.2 is het meest nabijgelegen Natura 2000-gebied het 'Wierdense Veld' welke op een afstand van ruim 1,3 kilometer is gelegen. Gelet op de grote afstand en de aard en omvang van de ontwikkeling wordt gesteld dat er geen sprake is van negatieve effecten op de instandhoudingsdoelstellingen van het Natura 2000-gebied.
...
Het plangebied betreft een bestaand woongebied en het bestemmingsplan heeft een overwegend conserverend karakter. De huidige inrichting en het beheer maken het projectgebied tot een ongeschikt leefgebied voor de meeste beschermde soorten. Er is geen sprake van bestaande bebouwing welke mogelijk functioneel leefgebied zou kunnen vormen van bijvoorbeeld vleermuizen. Gezien de aard en omvang van het initiatief wordt verwacht dat er geen beschermde soorten verstoord, beschadigd of gedood worden en er geen beschermd functioneel leefgebied wordt aangetast.

Daarnaast wordt gesteld dat het projectgebied, mede gelet op de terreingesteldheid en het onderhoud hiervan, ongeschikt is voor beschermde flora.
...
Het plan heeft geen negatieve effecten op Natura 2000-gebieden of het NNN. Het plan leidt naar verwachting niet tot wettelijke consequenties in het kader van soort- of gebiedsbescherming.
...
De gemeente Hellendoorn kent geen archeologische verwachtingskaart. Het plangebied is daarom getoetst aan de provinciale archeologische verwachtingskaart uit de provinciale Omgevingsvisie.

*Figuur 5.4 Uitsnede van de archeologische verwachtingskaart (Bron: Provincie Overijssel)*

Zoals blijkt uit figuur 5.4 is het plangebied gelegen in een gebied met een hoge archeologische verwachtingswaarde. Het plangebied maakt echter onderdeel uit van de Kruidenwijk. Tijdens het bouwrijp maken van de ondergrond voor de aanleg van deze wijk is het vrijwel zeker dat het plangebied, gezien de ligging binnen deze wijk, is meegenomen. Hierdoor is de bovenste grondlaag reeds geroerd.

Gezien de aard en omvang van de ontwikkeling is dan ook niet te verwachten dat er sprake zal zijn van verlies of beschadiging van enige archeologische waarden. Daarom wordt archeologisch onderzoek niet noodzakelijk geacht. Een archeologische dubbelbestemming hoeft niet opgenomen te worden.
...
datzelfde rijksbeleid staat ook een voorkeursvolgorde voor het omgaan met waterstromen. Het beleid is erop gericht schone waterstromen te scheiden van verontreinigde waterstromen.
...
Zoals te zien is op de foto's in hoofdstuk 2 is het plangebied in de huidige situatie onbebouwd. Ondanks de bouw van de dubbele woning is er slechts sprake van een kleine toename, circa 250 m², van het verharde oppervlak.

#### *6.2.3.2 Afvalwater*

Het afvalwater van de woningen zal worden afgevoerd via het gemengd rioolstelsel naar de RWZI Nijverdal. Met de toevoeging van twee woningen is geen sprake van een onevenredige toename van het afvalwater. De RWZI Nijverdal beschikt over voldoende capaciteit om deze geringe toename van afvalwater te kunnen verwerken.
...
# <span id="page-39-1"></span><span id="page-39-0"></span>**HOOFDSTUK 7JURIDISCHE ASPECTEN EN PLANVERANTWOORDING**
...
Deze regel is opgenomen om te verduidelijken in welke gevallen de Bouwverordening buiten toepassing kan blijven en ik welke gevallen de voorschriften uit de Bouwverordening wel van toepassing zijn.
...
In voorliggend geval is de bestemming 'Wonen – 1' opgenomen omdat deze bestemming qua maatvoering en de gemeentelijke voorwaarden voor dit plan het beste past bij de geprojecteerde woningen. Ten behoeve van het bouwkundig ontwerp zijn wel enkele wijzigingen gemaakt. In de eerste plaats is de maatvoering ten aanzien van het aantal toegestane wooneenheden binnen het plangebied van 1 naar 2 verandert. Dit was noodzakelijk om de twee-onder-een kap woning mogelijk te maken. Daarnaast is de maximale goothoogte van het hoofdgebouw van 3,5 meter aangepast naar 4 meter.

De gronden met de bestemming 'Wonen -1' zijn bedoeld voor wonen, aan huis verbonden beroepen en water.
...
Deze realisatieclausule is opgenomen binnen de afwijkingen van de gebruiksregels.
...
# <span id="page-43-1"></span><span id="page-43-0"></span>**HOOFDSTUK 9 VOOROVERLEG EN INSPRAAK**
...
Gelet op de aard en omvang van de in dit bestemmingsplan voorgenomen ontwikkeling, wordt het voeren van vooroverleg met de provincie niet noodzakelijk geacht.
...
# <span id="page-43-2"></span>**9.2 Inspraak**
...
Vanaf woensdag 2 mei 2018 heeft het ontwerpbestemmingsplan "Engelwortel Kruidenwijk" gedurende zes weken ter inzage gelegen. Van de mogelijkheid die aan een ieder is geboden om zienswijzen in te dienen tegen het ontwerpbestemmingsplan, is door niemand gebruik gemaakt.

**Bestemmingsplan Engelwortel Kruidenwijk** Vastgesteld

# <span id="page-44-0"></span>**BIJLAGEN BIJ DE TOELICHTING**

# <span id="page-45-0"></span>**BIJLAGE 1: WATERTOETSRESULTAAT**
...
# **behorende bij wijziging bestemmingsplan Oeffelt ten behoeve van de bouw van een woning op het perceel Z 5067 en Z 5068 gedeeltelijk aan de Hogehoek te Oeffelt**
...
|    | 3.1                   | Milieuaspecten                     | 7  |  |  |  |
|    | 3.2                   | Fysieke aspecten                   | 11 |  |  |  |
|    | 3.3                   | Economische en financiële aspecten | 14 |  |  |  |
|    | 3.4                   | Handhaafbaarheid                   | 14 |  |  |  |
| 4. | ADVIEZEN EN RAPPORTEN | 14                                 |    |  |  |  |
...
Een van deze wijzigingsbevoegdheden (nummer 9) ligt op het perceel dat gelegen is tussen de woningen Hogehoek 18c en 22.

Burgemeester en wethouders zijn bevoegd de bestemming 'Agrarisch' te wijzigen in de bestemming 'Wonen' en op het perceel de bouw van een nieuwe woning toe te staan, mits voldaan is aan de volgende voorwaarden:

- 1. de woning past binnen het gemeentelijk volkshuisvestingsbeleid;
- 2. er is onderzoek verricht naar de planologisch relevante aspecten, zoals bodem, water, flora en fauna, luchtkwaliteit en archeologie.

Op de eerste voorwaarde wordt ingegaan in hoofdstuk 2.4. De resultaten van de in de tweede voorwaarde genoemde onderzoeken zijn beschreven in hoofdstuk 3.
...
Het plangebied ligt in bestaand stedelijke gebied
...
Dit betekent dat zachte plannen voor minimaal 18 woningen hard gemaakt moeten worden. De te bouwen woning aan de Hogehoek staat vermeld op de lijst zachte plannen.
...
Het perceel ligt aan een 30 km/h weg en daarom is alleen het gemeentelijk geluidbeleid van toepassing. Volgens het gemeentelijk beleid valt het gebied in gebiedstype C. De ambitiewaarde voor dit gebied is vastgesteld op 43 dB en de basiswaarde op 53 dB. Afhankelijk van de situering van de woning zou de ambitiewaarde overschreden kunnen worden. De basiswaarde zal niet overschreden worden. Vanuit het aspect geluid is er geen belemmering voor de ontwikkeling.
...
Op 1 januari 2003 is de Woningwet gewijzigd. Een van de wijzigingen had betrekking op de uitoefening van het welstandstoezicht. Ingevolge de Woningwet moeten bouwplannen beoordeeld worden op basis van vooraf vastgelegde welstandscriteria waarin zo concreet mogelijk moet staan

wat het criterium 'redelijke eisen van welstand' inhoudt. De beleidsregels van de gemeente Boxmeer zijn in 2004 vastgelegd in de Welstandsnota, die op 16 juli 2014 vervangen is door de op 3 juli 2014 door de gemeenteraad vastgestelde Welstandsnota 2014.
...
In augustus 2017 heeft Lankelma Geotechniek Zuid B.V. een verkennend bodemonderzoek uitgevoerd. Hieruit wordt geconcludeerd, dat:

- op grond van de onderzoeksresultaten de gestelde hypothese 'onverdachte locatie' aangenomen moet worden;
- een aanvullend of nader bodemonderzoek niet nodig is;

• er op indicatieve wijze op of in de bodem géén asbestverdachte materialen zijn aangetroffen. De aangetroffen bodemkwaliteit vormt geen belemmering voor de bestemmingswijziging en het voorgenomen bouwplan.
...
In de omgeving van het plangebied zijn geen risicobronnen aanwezig. Het plan past daarnaast binnen de aanvullende kaders zoals die zijn vastgelegd in de beleidsvisie externe veiligheid van de gemeente Boxmeer.

#### **Conclusie**

Externe veiligheid vormt geen belemmering voor het ruimtelijk plan.
...
In onderhavig geval is sprake van sprake van de bouw van één woning en daarom kan gesproken worden van een Niet-in-betekenende-mate (NIBM) bijdrage aan de verslechtering van de luchtkwaliteit.
...
Het perceel ligt in Archeologisch onderzoeksgebied A, zodat de dubbelbestemming Waarde – archeologie 3 van toepassing is.
...
In juli 2017 heeft Öko Care een ecologische quickscan uitgevoerd. Geconcludeerd wordt dat de aanwezige relatief schrale natuurwaarden ter plaatse in voldoende mate onderzocht zijn en voldoende inzicht bieden om in dit kader de wijziging van de bestemming te beoordelen.

- Wet Natuurbescherming. Omdat alle vogel- en zoogdiersoorten als beschermde soort worden aangemerkt, wordt geadviseerd de werkzaamheden buiten het broedseizoen uit te voeren.
- Zorgplicht. De zorgplicht die voor alle planten en dieren geldt, houdt in dat menselijk handelen geen nadelige gevolgen voor flora en fauna mag hebben. Geadviseerd wordt de bestaande vegetatie na de zomerperiode te verwijderen en vervolgens in de herfst of begin winter het grondwerk voor de nieuwbouw uit te voeren.
- Nesten van jaarrond beschermde vogels zijn niet aangetroffen. Er bevinden zich geen direct aan de locatie grenzende gebieden die kunnen worden aangemerkt als Natura 2000 gebied of die onder de Vogel- en Habitatrichtlijn vallen. De voorgenomen plannen zullen geen effect hebben op deze gebieden of nabij gelegen ecologische verbindingszones of een Natura 2000 gebied in de regio of erbuiten.
- Indien de nieuwe woning voorzien wordt van een hellend pannendak, bestaat er onder andere de mogelijkheid om een vogelvide in de onderste rij dakpannen te integreren of één of meer nestkasten van de huismus te plaatsen.
...
De Hogehoek maakt deel uit van het verblijfsgebied binnen de bebouwde kom van Oeffelt (maximum snelheid 30 km/h). Een extra woning genereert een geringe hoeveelheid extra verkeer; problemen zijn daarom niet te verwachten.

Parkeren moet op eigen terrein plaats te vinden. De parkeernorm voor vrijstaande woningen in deze situatie is 2,3 parkeerplaats/woning; afgerond twee parkeerplaatsen.

Voor een eventuele nieuwe uitweg op de Hogehoek is een uitwegvergunning nodig.
...
Vanaf 2008 mag het regenwater niet meer worden afgevoerd naar de riolering, maar moet het geborgen worden op eigen terrein. Mits er geen gevaar bestaat dat het regenwater kan worden afgewimpeld naar belendende percelen, dan kan volstaan worden met een berging van 30 mm/m² verhard oppervlak (hier wordt onder verstaan dakvlak en bestrating). Indien de bodem onvoldoende doorlatend is dan moet de berging 45 mm/m² bedragen.
...
- Verkennend bodemonderzoek, Lankelma Geotechniek d.d. 8 augustus 2017
- Ecologische quickscan flora en fauna, Öko Care d.d. 27 juli 2017.
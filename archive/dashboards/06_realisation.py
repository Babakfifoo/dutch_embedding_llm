...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_realisation.json"
LLM_answer_file = "./data/plan_documents/answered/realisation agreement.json"
FACTOR = "Realisation Agreement"

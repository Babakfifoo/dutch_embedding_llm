...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_space_for_space.json"
LLM_answer_file = "./data/plan_documents/answered/space for space.json"
FACTOR = "Space for Space"

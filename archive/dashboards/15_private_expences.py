...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_private_expences.json"
LLM_answer_file = "./data/plan_documents/answered/private expenses.json"
FACTOR = "Private Expences"

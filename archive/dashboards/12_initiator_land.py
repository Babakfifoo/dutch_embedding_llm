...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_developer_land.json"
LLM_answer_file = "./data/plan_documents/answered/private ownership.json"
FACTOR = "Developer Land"

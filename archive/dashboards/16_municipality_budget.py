...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_municipality_costs.json"
LLM_answer_file = "./data/plan_documents/answered/municipality_costs.json"
FACTOR = "municipality_costs"

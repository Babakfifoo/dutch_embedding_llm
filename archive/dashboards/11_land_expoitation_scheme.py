...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_land_exp_scheme.json"
LLM_answer_file = "./data/plan_documents/answered/land exploitation scheme.json"
FACTOR = "Land Exploitation Scheme"

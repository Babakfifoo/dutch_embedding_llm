...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_building_plan.json"
LLM_answer_file = "./data/plan_documents/answered/building Plan.json"
FACTOR = "Building Plan"

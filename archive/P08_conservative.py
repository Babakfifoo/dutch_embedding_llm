...
"""
This script identifies the plans that are conservative in nature, do n o expect any development or just for management.
"""
...
prompt: str = """
    ...
    Based on the provided context, if the plan is described as "conservative in nature", "not expecting construction"
, not expecting housing development", "is a management plan", return `True`. 

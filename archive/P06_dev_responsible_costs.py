...
prompt: str = """
    ...
    Based on the provided context, is the developer, applicant, or the initiator responsible for costs or costs are passed to them?

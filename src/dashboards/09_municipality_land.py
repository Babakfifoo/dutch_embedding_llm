...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_municipality_land.json"
LLM_answer_file = "./data/plan_documents/answered/municipality ownership.json"
FACTOR = "Municipal Land"

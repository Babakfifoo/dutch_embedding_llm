...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_plan_damage.json"
LLM_answer_file = "./data/plan_documents/answered/plan damage agreement.json"
FACTOR = "Plan Damage Agreement"

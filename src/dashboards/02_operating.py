...
manual_answers_file = "./data/plan_documents/results/inspecting_false/result_operating.json"
LLM_answer_file = "./data/plan_documents/answered/operating agreement.json"
FACTOR = "operating Agreement made"

...
manual_answers_file = (
    "./data/plan_documents/results/manual_inspection/inspection_anterior.json"
)
LLM_answer_file = "./data/plan_documents/answered/anterior agreement.json"
FACTOR = "Anterior Agreement made"

if "original" not in st.session_state:
    with open(file=LLM_answer_file, mode="r") as f:

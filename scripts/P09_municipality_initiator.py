...
"""
This script identifies the plans that municipality is described as the initiator
...
prompt: str = """
    ...
    Based on the provided context, Is the municipality initiator of the project, or the plan?.
